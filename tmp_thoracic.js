// THORACIC DEPARTMENT — IDs: lung-cancer, pneumothorax, empyema, mesothelioma, thymoma, esophageal-perforation, hemothorax, lung-abscess, mediastinal-mass, chest-wall-tumor, pectus, lung-carcinoid
const THORACIC_DISEASES = [
{
  ...
  mnemonics: [
    {name:"Pancoast syndrome", text:"Superior sulcus tumor: Horner's (ptosis+miosis+anhidrosis) + Brachial plexus (C8/T1) pain + Rib destruction"},
  ...
  diagnosis: {
    history: [
      "Persistent cough (new or changed pattern), hemoptysis",
      "Dyspnea, chest pain, weight loss, fatigue",
      "Hoarseness (left RLN — aortopulmonary window nodes)",
      "Superior vena cava (SVC) obstruction: facial edema, distended neck veins",
      "Pancoast syndrome: shoulder/arm pain, Horner's syndrome (superior sulcus tumor)",
      "Paraneoplastic: Cushing's (SCLC — ACTH), SIADH, Lambert-Eaton (SCLC), hypercalcemia (PTHrP, squamous)"
    ],
    examination: [
      "Clubbing (10% NSCLC)",
  ...
  criteria: {
    ...
    items: [
      ...
      {k:"Cardiac fitness", v:"No unrevascularized CAD; ECHO if clinical concern"},
  ...
  management: {
    ...
    surgical: [
      ...
      {name:"Segmentectomy (anatomical)", when:"Stage IA (<2cm); poor pulmonary reserve (FEV₁ppo 30–40%); peripheral lesions", notes:"Non-inferior to lobectomy for stage IA tumors (JCOG0802/WJOG4607L trials); anatomical segmentectomy only (not wedge resection for curative intent)"},
      {name:"Pneumonectomy", when:"Centrally located tumor requiring right or left pneumonectomy; invasion of main pulmonary artery/vein; stage IIIA selected", notes:"High morbidity: mortality 3–5%; right pneumonectomy higher risk than left; bronchopleural fistula 3–5%"},
  ...
  technique: {
    ...
    steps: [
      ...
      {n:5, t:"Bronchus", d:"Dissect RUL bronchus; ensure no tumor at bronchial margin; apply linear stapler (4.8mm load) at bronchial origin"},
...
},
{
  ...
  differentials: ["Tension pneumothorax","Hemothorax","Pleural effusion","Bullous emphysema (looks like PTX on CXR)","Pneumomediastinum"],
  mnemonics: [
  ...
  diagnosis: {
    history: [
      ...
      "Tension: rapidly progressive breathlessness + hemodynamic collapse"
    ],
    examination: [
      "Tachycardia, tachypnea, reduced SpO₂",
  ...
  management: {
    ...
    surgical: [
      ...
      {name:"Intercostal drain (ICD)", when:"SSP (all); failed aspiration; tension PTX (after needle decompression); hemopneumothorax; mechanical ventilation; bilateral PTX", notes:"4th/5th ICS MAL; 20–24Fr; connect to underwater seal; daily CXR; do NOT clamp; remove when lung expanded + air leak stopped for ≥24h"},
  ...
  technique: {
    ...
    prep: [
      ...
      "Sterile technique; local anesthetic (10–15mL lidocaine)"
    ],
    steps: [
      {n:1, t:"Anesthesia", d:"Infiltrate skin, subcutaneous tissue, intercostal muscle and parietal pleura with lidocaine"},
      ...
      {n:3, t:"Blunt dissection", d:"Blunt hemostat through intercostal muscles; 'pop' through parietal pleura; sweep finger to confirm pleural space and exclude adhesions"},
      {n:4, t:"Drain insertion", d:"Guide drain with finger into pleural cavity; direct posteriorly for fluid (hemothorax), apically for PTX; advance until all holes are intrathoracic"},
...
},
{
  ...
  hero: "Infected pleural fluid (frank pus, organisms on culture, or pH <7.2). Progresses from exudative → fibrinopurulent → organizing. Early drainage ± intrapleural fibrinolytics; organized empyema requires VATS decortication.",
  keypoints: [
    ...
    "Three phases: exudative (drainage alone), fibrinopurulent (drainage + fibrinolytics), organizing (VATS/open decortication)",
    "Intrapleural fibrinolytic therapy (tPA + DNase): reduces need for surgery in fibrinopurulent phase (MIST2 trial)",
    "VATS decortication: gold standard for fibrinopurulent/early organizing; open for organized empyema"
  ],
  differentials: ["Malignant pleural effusion","Transudative pleural effusion (heart failure, cirrhosis)","Hemothorax","Chylothorax","Tuberculous pleuritis"],
  mnemonics: [
  ...
  overview: {
    definition: "Collection of infected fluid in the pleural space, arising from parapneumonic spread, trauma, surgery, esophageal perforation, or hematogenous seeding.",
    ...
    classification: [
      ...
      "Phase 3: frank pus; fibrinopurulent/organizing — dense septations, loculated"
    ]
  },
  diagnosis: {
    history: [
      "Recent pneumonia, chest surgery, aspiration, esophageal procedure",
      ...
      "Hemoptysis preceding: lung abscess with empyema"
    ],
    examination: [
  ...
  management: {
    ...
    surgical: [
      ...
      {name:"Open thoracotomy and decortication", when:"Organized empyema >6 weeks; VATS not possible (extensive adhesions, dense peel); failed VATS", notes:"Posterolateral thoracotomy; parietal and visceral pleurectomy (decortication); significant blood loss; longer recovery"},
  ...
  technique: {
    ...
    pearls: [
      ...
      "Timing matters: fibrinolytics most effective in phase 2 (fibrinopurulent) — less effective in organized phase 3",
  ...
  pearls: [
    ...
    "VATS within 6 weeks of onset: most successful; after 6 weeks peel is organized → open decortication",
  ...
  mistakes: [
    ...
    "Delaying VATS beyond 6 weeks — organized peel cannot be removed by VATS; requires painful open decortication"
  ]
},
{
  ...
  organ: "Esophagus",
  severity: "high",
  tags: ["thoracic","emergency","esophagus","mediastinitis"],
  ...
  keypoints: [
    ...
    "Immediate CT esophagus with oral contrast (water-soluble); NOT barium initially",
    "Treatment: primary repair ± pleural drainage for early (<24h) contained; esophagectomy or exclusion/diversion for late/necrotic"
  ],
  differentials: ["Aortic dissection","Myocardial infarction","Acute pancreatitis","Peptic ulcer perforation","Hemothorax","Spontaneous pneumothorax"],
  mnemonics: [
    ...
    {name:"Esophageal perforation location by cause", text:"Instrumentation: posterior pharynx (Killian's dehiscence area), lower esophagus; Spontaneous (Boerhaave): distal left posterolateral; Foreign body: PES or cricopharyngeus"}
  ],
  overview: {
    definition: "Full-thickness disruption of the esophageal wall allowing luminal contents (saliva, food, gastric acid) to leak into the mediastinum or pleural cavity, causing mediastinitis.",
    ...
    pathophysiology: "Gastric contents (acid, enzymes, organisms) contaminate mediastinum → chemical + bacterial mediastinitis → rapidly fatal. Distal esophageal perforation → left pleural contamination (mediastinal pleura thinner on left). Mediastinitis = systemic inflammatory response → multi-organ failure.",
    classification: [
  ...
  diagnosis: {
    history: [
      ...
      "Iatrogenic: pain/dysphagia after esophageal instrumentation (endoscopy, dilation, intubation)",
      "Hematemesis (associated Mallory-Weiss or concurrent)",
      "Fever, dyspnea (mediastinitis/pleural effusion)"
    ],
    examination: [
    ...
    investigations: [
      ...
      {name:"Upper GI endoscopy", role:"Careful — confirm and characterize perforation (size, location); plan endoscopic or surgical management; use only in stable patients; risk of worsening contamination with air insufflation"},
      {name:"CBC, CRP, lactate, blood cultures", role:"Assess severity; bacteremia common with established mediastinitis"}
    ]
  },
  criteria: {
    title: "Pittsburgh Perforation Severity Score",
    items: [
      {k:"Points assigned for:", v:"Age >75, tachycardia, leukocytosis, pleural effusion, early (<24h), cancer, esophageal cause"},
  ...
  management: {
    ...
    surgical: [
      {name:"Primary repair + tissue reinforcement", when:"Early presentation (<24h); viable tissue; contained contamination", notes:"Thoracotomy (left for Boerhaave's — left 6th ICS posterolateral); debride perforation edges; 2-layer interrupted closure (mucosa + muscularis/adventitia) with absorbable suture; reinforce with pleural flap, intercostal muscle, or omentum; drain mediastinum and pleural space; T-tube esophagostomy if tissue poor quality"},
      {name:"Esophageal exclusion and diversion", when:"Late presentation (>24h); non-viable tissue; extensive contamination; primary repair not possible", notes:"Cervical esophagostomy (controlled fistula) + gastrostomy/jejunostomy for feeding; esophagus excluded from circuit; delayed reconstruction 6–12 months when sepsis controlled"},
      {name:"Esophagectomy", when:"Perforation associated with carcinoma; large segment necrosis; after failed repair", notes:"Technically very demanding in contaminated/septic field; high mortality; consider staged approach"},
      {name:"T-tube esophagostomy", when:"Repair at risk of breakdown; elderly/frail; early but delayed viable tissue", notes:"T-tube placed through perforation; controlled fistula heals spontaneously when tube removed"},
  ...
  technique: {
    title: "Primary Repair of Boerhaave's Esophageal Perforation",
    prep: [
    ...
    steps: [
      {n:1, t:"Mediastinum access", d:"Open mediastinal pleura over lower esophagus; drain all contaminated pleural fluid and food debris"},
      ...
      {n:3, t:"Debridement", d:"Excise devitalised esophageal edges; fresh viable tissue for repair"},
    ...
    pearls: [
      "Esophageal mucosa extends FURTHER than muscle tear — always extend muscular incision to expose full mucosal extent before repair",
  ...
  guidelines: [
    {src:"ESGE/EACTS Guidelines 2019: Management of esophageal perforations, Mallory-Weiss, and Boerhaave"},
    {src:"AUGIS: UK esophageal perforation management guidelines"},
    {src:"Schweigert et al.: Esophageal perforation — algorithm for management"}
  ],
  pearls: [
    "Mackler's triad should prompt immediate CT esophagus — Boerhaave's is immediately life-threatening",
...
},
{
  ...
  hero: "Blood in the pleural space. Most commonly from trauma. Massive hemothorax (>1500mL): immediate ICD + consider thoracotomy. Retained hemothorax: VATS within 7–10 days.",
  keypoints: [
    "Massive hemothorax: >1500mL blood (half total blood volume) — hemodynamic shock + absent breath sounds + dull percussion",
    "ICD (28–32Fr): immediate drainage of hemothorax; cell salvage if auto-transfusion available",
    "Thoracotomy: >1500mL immediate drainage OR >200mL/hr × 3h OR persistent hemodynamic instability",
    "Retained hemothorax: undrained blood → fibrothorax/empyema; VATS within 7–10 days",
    "Clotted hemothorax: ICD inadequate — VATS drainage"
  ],
  differentials: ["Pleural effusion (non-hemorrhagic)","Empyema","Chylothorax","Rupture of thoracic aortic aneurysm","Hemopneumothorax"],
  mnemonics: [
    {name:"Massive hemothorax definition", text:"Massive = >1500mL acute drainage OR >200mL/hr × 3 hours = thoracotomy criteria"}
  ],
  overview: {
    ...
    epidemiology: "Hemothorax in 40% of major chest trauma patients. Massive hemothorax (>1500mL): 3–5% of chest trauma. Delayed hemothorax: presents 2–7 days after trauma.",
    pathophysiology: "Blood in pleural space: from intercostal vessels (most common), pulmonary vessels, intrathoracic great vessels, or aorta. Fibrinolytic activity of pleural mesothelium delays clotting → hemothorax usually unclotted acutely. Retained hemothorax → fibrothorax (trapped lung) or infected (empyema).",
    classification: [
      "Simple hemothorax (<500mL): often self-limiting",
      "Moderate hemothorax (500–1000mL): ICD",
      "Massive hemothorax (>1500mL): emergency",
  ...
  diagnosis: {
    history: [
      ...
      "Anticoagulation or coagulopathy (spontaneous hemothorax)",
      "Breathlessness and chest pain after trauma",
      "Hemodynamic instability (massive)"
    ],
    examination: [
      "Dull to percussion (fluid)",
      "Reduced/absent breath sounds",
      "Hemodynamic instability (massive hemothorax)",
      "Signs of associated pneumothorax (hyper-resonance + dullness = hemopneumothorax)"
    ],
    investigations: [
      {name:"eFAST", role:"Bedside: free pleural fluid; sensitivity 75–90% for hemothorax"},
      {name:"CXR", role:"Opacification of hemithorax; ≥200mL to be visible; supine CXR less sensitive (layering)"},
      {name:"CT chest", role:"Stable patients: confirms hemothorax, quantifies volume, identifies source, associated injuries"},
      {name:"Pleural fluid hematocrit", role:"Hemothorax if pleural fluid hematocrit >50% of peripheral blood hematocrit"}
    ]
  },
  criteria: {
    title: "Thoracotomy Indications for Hemothorax",
    items: [
      {k:">1500mL immediate ICD output", v:"Massive hemothorax — thoracotomy"},
      {k:">200mL/hr × 3 hours", v:"Ongoing arterial hemorrhage — thoracotomy"},
      {k:"Persistent hemodynamic instability", v:"Hemorrhage source in chest — thoracotomy"},
      {k:"Clotted retained hemothorax", v:"VATS within 7–10 days"},
      {k:"VATS-inaccessible retained hemothorax", v:"Open thoracotomy if VATS fails or too late"}
    ]
  },
  scoring: [],
  management: {
    conservative: [
      "Small hemothorax (<500mL): supplemental O₂, monitoring, repeat CXR",
      "Correct coagulopathy if spontaneous hemothorax"
    ],
    medical: [
    ...
    surgical: [
      {name:"Intercostal drain (ICD)", when:"Hemothorax >500mL or symptomatic; mandatory before mechanical ventilation", notes:"Large-bore 28–32Fr; 4th/5th ICS MAL; cell salvage/auto-transfusion if available; measure initial output; continue monitoring drainage rate"},
      {name:"Thoracotomy", when:"Massive hemothorax criteria met; ongoing hemorrhage; hemodynamic instability from chest", notes:"Posterolateral or anterolateral approach based on injury side; identify and control bleeding source (intercostal vessel ligation, pulmonary tractotomy, lobectomy, vessel repair)"},
      {name:"VATS for retained hemothorax", when:"Undrained clotted hemothorax or retained hemothorax >7 days — prevents fibrothorax", notes:"Within 7–10 days of injury: best results; evacuate clot, deloculate, ensure lung re-expansion; converts to open if bleeding or dense adhesions"},
      {name:"Pulmonary tractotomy", when:"Through-and-through lung injury with hemorrhage", notes:"Staple across injury tract parallel to vessels and bronchi; controls hemorrhage from deep parenchymal injuries without lobectomy"},
      {name:"Intercostal vessel ligation", when:"Persistent hemothorax from intercostal vessel", notes:"Ligate both ends of vessel (proximal and distal to perforation — both ends bleed due to collateral flow)"}
    ]
  },
  technique: {
    title: "VATS Evacuation of Retained Hemothorax",
    prep: [
    ...
    steps: [
      ...
      {n:2, t:"Clot removal", d:"Use graspers, suction, irrigation to break up and remove organized clot; avoid tearing lung or diaphragm"},
      {n:3, t:"Decortication", d:"If fibrin peel present: remove from visceral pleura to allow lung re-expansion"},
      {n:4, t:"Hemostasis", d:"Identify any ongoing bleeding source; ligate or cauterise"},
    ...
    pearls: [
      "VATS for retained hemothorax best within 10 days — after 3–4 weeks, clot organizes into inoperable fibrothorax",
  ...
  guidelines: [
    {src:"EAST Practice Management Guidelines: Hemothorax"},
    {src:"BTS Guidelines 2010: Intercostal chest drain insertion"},
    {src:"ATLS 10th Edition: Chest trauma — massive hemothorax"}
  ],
  pearls: [
    "Intercostal vessels bleed from BOTH proximal and distal ends — ligate BOTH for hemostasis",
    "Delayed hemothorax: 2–7 days post-trauma; rib fragment erodes vessel; always monitor trauma patients serially",
    "Fibrothorax: organized hemothorax (untreated) → trapped lung → reduced lung function; open decortication required"
  ],
  mistakes: [
    "Small ICD for hemothorax — 16–20Fr blocks with clot; use 28–32Fr",
    "Not measuring initial ICD output for massive hemothorax — miss indication for thoracotomy",
    "Delaying VATS for retained hemothorax — organized fibrothorax after 3–4 weeks requires morbid open decortication"
  ]
},
{
  id: "mesothelioma",
  ...
  differentials: ["Malignant pleural effusion from lung cancer/breast cancer","Benign asbestos-related pleural disease","Pleural fibrous tumor","Adenocarcinoma of lung with pleural involvement"],
  mnemonics: [
  ...
  overview: {
    definition: "Malignant tumor arising from the pleural mesothelial cells, associated with asbestos fiber exposure, presenting with progressive pleural effusion and encasement of the lung.",
    ...
    pathophysiology: "Crocidolite (blue asbestos) most carcinogenic fiber type. Fibers impacted in pleura → reactive oxygen species → DNA damage → p16/CDKN2A, NF2, BAP1 mutations → malignant transformation. Tumor grows as sheets encasing lung (rind).",
    classification: [
  ...
  diagnosis: {
    ...
    examination: [
      ...
      "Chest wall fixation and reduced chest expansion (tumor encasing)",
      "Clubbing (uncommon)",
  ...
  criteria: {
    ...
    items: [
      {k:"Stage I", v:"T1N0M0: localized ipsilateral pleural disease only"},
  ...
  management: {
    ...
    medical: [
      ...
      "Alternative first-line: cisplatin + pemeterxed ± bevacizumab (Mesothelioma Avastin Cisplatin Pemeterxed Study — MAPS)",
      "Folic acid + B12 supplementation with pemeterxed — reduces hematological toxicity",
    ...
    surgical: [
      ...
      {name:"Extrapleural pneumonectomy (EPP)", when:"Selected epithelioid stage I–II; young; fit; multimodality approach (induction chemo + EPP + hemithoracic RT); specialist center only", notes:"Removes entire lung + parietal pleura + ipsilateral diaphragm + pericardium; very high morbidity (40–50%) and mortality (3–5%); OS benefit vs non-surgical controversial"},
  ...
  technique: {
    ...
    steps: [
      ...
      {n:2, t:"Pleural assessment", d:"Inspect entire pleural cavity; identify distribution of tumor (localized vs diffuse rind)"},
  ...
  guidelines: [
    ...
    {src:"MAPS trial: Bevacizumab + cisplatin/pemeterxed in mesothelioma"}
  ],
  pearls: [
    "Asbestos-exposed workers: 20–50 year latency — mesothelioma may present decades after exposure cessation",
    "All newly diagnosed mesothelioma: MDT review at specialist center; tissue diagnosis mandatory",
...
},
{
  id: "thymoma",
  dept: "thoracic",
  name: "Thymoma / Thymic Tumor",
  latin: "Thymoma",
  organ: "Thymus",
  severity: "moderate",
  tags: ["thoracic","mediastinum","thymus","oncology"],
  hero: "Most common anterior mediastinal tumor in adults. Associated with myasthenia gravis (30%). Complete resection is the only curative treatment. WHO classification guides prognosis.",
  keypoints: [
  ...
  differentials: ["Germ cell tumor (teratoma)","Lymphoma (anterior mediastinum)","Thyroid goitre substernal","Parathyroid adenoma","Lipoma","Cyst (thymic, pericardial)"],
  mnemonics: [
  ...
  overview: {
    definition: "Epithelial tumor of the thymus, arising from the anterior mediastinum, classified by WHO based on the proportion of epithelial cells to lymphocytes and degree of atypia.",
    epidemiology: "0.13/100,000/year. Peak age 50–60 yrs. No gender predilection. 30–50% associated with myasthenia gravis, 5% with red cell aplasia, 3% with hypogammaglobulinemia.",
    ...
    classification: [
      ...
      "Masaoka staging: I (intact capsule) → IV (hematogenous metastases)"
    ]
  },
  diagnosis: {
    history: [
      ...
      "SVC syndrome (superior vena cava obstruction: facial plethora, arm edema)",
      "Myasthenia gravis symptoms: diplopia, ptosis, dysphagia, proximal muscle weakness, respiratory compromise (MG crisis)",
      "Paraneoplastic: pure red cell aplasia, hypogammaglobulinemia"
    ],
    examination: [
    ...
    investigations: [
      ...
      {name:"Neurological assessment + pulmonary function tests", role:"Pre-op assessment for MG; respiratory reserve in MG patients critical for anesthesia"},
  ...
  criteria: {
    ...
    items: [
      ...
      {k:"Stage IVb", v:"Lymphogenous or hematogenous metastases"}
    ]
  },
  scoring: [],
  management: {
    ...
    medical: [
      "Pre-op MG optimization: pyridostigmine + steroids; plasmapheresis if severe MG pre-surgery",
    ...
    surgical: [
      ...
      {name:"Thymectomy for MG (without thymoma)", when:"All patients with MG <60 yrs with generalized disease; MGTX trial confirms benefit", notes:"Complete thymectomy including mediastinal fat; VATS or sternotomy; long-term immunosuppression titration post-op"}
    ]
  },
  technique: {
  ...
  guidelines: [
    ...
    {src:"ESMO Clinical Practice Guidelines 2021: Thymic epithelial tumors"},
  ...
  mistakes: [
    "Not screening thymoma patients for MG pre-op — unrecognized MG causes post-op respiratory crisis",
...
},
{
  ...
  hero: "Location defines differential: anterior (4Ts: thymoma/teratoma/lymphoma/thyroid), middle (lymphoma/cyst/tracheal), posterior (neurogenic tumors). CT + biopsy guide diagnosis.",
  keypoints: [
  ...
  overview: {
    definition: "Any abnormal tissue in the mediastinum identified on chest imaging, requiring characterization and tissue diagnosis in most cases.",
    epidemiology: "Mediastinal tumors: ~30–50% in anterior compartment, 20–30% middle, 25–30% posterior. Adults: most common malignant = lymphoma; most common overall = thymoma/GCT. Children: most common = lymphoma, neuroblastoma.",
    pathophysiology: "Depends on histotype. Neurogenic tumors (posterior): from dorsal nerve roots/sympathetic chain. Germ cell tumors (anterior): misplaced primordial germ cells. Lymphoma: mediastinal lymph node involvement.",
    classification: [
      "Anterior compartment: thymoma, GCT (teratoma/seminoma/NSGCT), lymphoma (Hodgkin's), substernal goitre, parathyroid, lipoma",
      "Middle compartment: lymphoma, tracheal tumor, bronchogenic cyst, pericardial cyst, cardiac tumor",
      "Posterior compartment: schwannoma, neurofibroma, ganglioneuroma, neuroblastoma (children), PNET, vertebral tumor, thoracic duct cyst"
    ]
  },
  diagnosis: {
    history: [
      "Many incidental (on CXR/CT for other reasons)",
      "SVC syndrome: anterior large mass — facial edema, arm swelling, dilated neck veins",
      "Airway compression: stridor, dyspnea, orthopnea",
      "Dysphagia: esophageal compression (posterior)",
      "MG symptoms (thymoma)",
      "B symptoms (lymphoma): fever, night sweats, weight loss",
      "Back pain, radicular symptoms (posterior neurogenic tumors)"
    ],
    examination: [
      "SVC obstruction signs",
      "Tracheal deviation",
      "Vocal cord palsy (hoarseness — mediastinal LN compressing RLN)",
      "Horner's syndrome (posterior tumor)",
    ...
    investigations: [
      ...
      {name:"AFP + beta-hCG", role:"Germ cell tumor markers; NSGCT: AFP or hCG elevated; pure seminoma: hCG only; teratoma: both negative"},
  ...
  criteria: {
    ...
    items: [
      ...
      {k:"Posterior neurogenic", v:"Surgical excision via VATS (posterior) ± spinal surgery if extending into foramina (dumbbell tumor)"}
    ]
  },
  scoring: [],
  management: {
    ...
    surgical: [
      {name:"VATS or robotic resection", when:"Anterior mediastinal tumors (<6cm, suspected thymoma/GCT, cysts); posterior neurogenic (schwannoma)", notes:"Minimally invasive; adequate for most small anterior masses; VATS posterior approach for schwannoma"},
      ...
      {name:"VATS posterior (or thoracoscopy)", when:"Posterior neurogenic tumors (schwannoma, ganglioneuroma)", notes:"Posterior VATS; spine surgeon for dumbbell tumors extending into foramina"},
  ...
  technique: {
    ...
    pearls: [
      ...
      "Dumbbell tumor (posterior neurogenic extending into spinal foramina): combined thoracic + spinal surgery in same session",
  ...
  guidelines: [
    ...
    {src:"ESMO: Germ cell tumor guidelines"},
  ...
  mistakes: [
    ...
    "Resecting posterior mass without spine imaging — dumbbell extension into foramina unrecognized"
  ]
},
{
  id: "lung-abscess",
  ...
  keypoints: [
    ...
    "Surgery (lobectomy/wedge): failure of medical treatment (>4 weeks), large abscess >6cm, complication (hemoptysis, empyema)",
  ...
  overview: {
    ...
    pathophysiology: "Aspiration of oral bacteria → pneumonitis → tissue necrosis → cavity formation. Gram-positive cocci (Staphylococcus aureus) in hematogenous abscess. Polymicrobial in aspiration. Secondary: cavitation of underlying tumor or granuloma.",
    classification: [
  ...
  diagnosis: {
    ...
    examination: [
      "Fever, tachycardia, toxic appearance",
      "Localized area of dullness, bronchial breathing, coarse crackles",
  ...
  criteria: {
    ...
    items: [
      ...
      {k:"Massive hemoptysis", v:"Emergency surgical intervention"},
  ...
  management: {
    conservative: [
      ...
      "Smoking cessation; optimize nutrition"
    ],
    medical: [
    ...
    surgical: [
      ...
      {name:"Pulmonary resection (lobectomy/segmentectomy)", when:"Failed medical treatment; large abscess >6cm; hemoptysis; suspected carcinoma; chronic abscess >6 weeks not resolving", notes:"VATS or open; anatomical resection; great care not to spill contaminated abscess contents into pleural cavity — may pack with gauze; double-lumen ET tube protects contralateral lung"}
    ]
  },
  technique: {
    title: "VATS Lobectomy for Chronic Lung Abscess",
    prep: [
      "Pre-op: optimize nutrition; antibiotics to reduce infectious burden",
...
},
{
  ...
  overview: {
    ...
    epidemiology: "Rare: 1–2% of all tumors. Metastatic disease to chest wall (lung/breast/kidney primary) far more common than primary chest wall tumors. Primary: chondrosarcoma 20%, followed by Ewing's sarcoma 15%, osteosarcoma 10%.",
    pathophysiology: "Chondrosarcoma: from costal cartilage or rib cartilaginous growth plate; slow-growing; locally invasive; hematogenous spread to lung. Ewing's sarcoma: small round blue cells; EWSR1-FLI1 translocation; aggressive; chemosensitive. Osteosarcoma: sclerotic/osteolytic; adolescents.",
    classification: [
  ...
  diagnosis: {
    ...
    investigations: [
      ...
      {name:"MRI chest wall", role:"Best soft tissue characterization; intramedullary extent; neurovascular involvement; soft tissue vs bone"},
      {name:"PET-CT", role:"Staging malignant chest wall tumors; exclude distant metastases; response to neoadjuvant"},
  ...
  criteria: {
    title: "Resection Margins for Malignant Chest Wall Tumors",
    items: [
      {k:"Bony margins", v:"≥4cm from radiological tumor edge (each rib/sternum)"},
  ...
  management: {
    ...
    surgical: [
      {name:"En-bloc wide local excision", when:"All primary chest wall malignant tumors; wide margins mandatory", notes:"Remove tumor + ≥4cm bony margin + soft tissue cuff; intercostal muscles, parietal pleura, lung parenchyma if involved; chest wall reconstruction immediately"},
      ...
      {name:"Sternal resection + reconstruction", when:"Chondrosarcoma or tumor involving sternum", notes:"Partial or total sternectomy; titanium sternal plates or PEEK prosthesis + muscle/skin flap coverage"},
  ...
  technique: {
    ...
    prep: [
      "CT + MRI: measure tumor extent and plan resection margins (draw on CT)",
    ...
    steps: [
      ...
      {n:3, t:"Rib resection", d:"Divide ribs ≥4cm from tumor; periosteal elevator + rib cutter; hemostasis of intercostal vessels"},
      ...
      {n:6, t:"Rigid prosthesis (if ≥3 ribs)", d:"Methylmethacrylate molded behind mesh or titanium plate system; fixed to remaining ribs with screws"},
...
},
{
  ...
  overview: {
    ...
    classification: [
      "Pectus excavatum: symmetric vs asymmetric; localized vs diffuse",
  ...
  diagnosis: {
    history: [
      ...
      "Exertional dyspnea, exercise intolerance (cardiopulmonary compression)",
  ...
  technique: {
    ...
    steps: [
      ...
      {n:2, t:"Thoracoscope insertion", d:"Right lateral 5mm port; visualize mediastinum and anterior chest wall"},
      ...
      {n:6, t:"Stabilizer plates", d:"Bilateral metal stabilizer plates affixed over bar at lateral chest wall to prevent rotation; fix to ribs with sutures/wire"},
  ...
  mistakes: [
    ...
    "Bar inserted without lateral stabilizer plates — bar rotation causes deformity recurrence",
...
},
{
  ...
  hero: "Low-grade neuroendocrine tumor of the lung. Typical carcinoid (TC): 85%, excellent prognosis. Atypical carcinoid (AC): 15%, intermediate prognosis. Surgical resection is curative for most patients.",
  keypoints: [
  ...
  differentials: ["Non-small cell lung cancer","Small cell lung cancer","Carcinoid tumor of GI tract","Atypical carcinoid (LCNEC)","Bronchial hamartoma","Metastatic carcinoid"],
  mnemonics: [
  ...
  overview: {
    ...
    epidemiology: "1–2% of all lung tumors. Mean age 55 yrs (TC younger than AC). F:M = 1:1. Central (TC) vs peripheral (AC). Carcinoid syndrome rare with pulmonary carcinoid (<5%).",
  ...
  diagnosis: {
    history: [
      "Central TC: recurrent hemoptysis, post-obstructive pneumonia, chronic cough",
      "Peripheral TC/AC: incidental finding on CXR/CT",
      "Carcinoid syndrome (rare): flushing, diarrhea, wheeze (usually from liver metastases — uncommon with pulmonary primary)",
    ...
    investigations: [
      ...
      {name:"Bronchoscopy ± biopsy", role:"Central tumors: visualize (pink, vascular, endobronchial mass); biopsy (risk of hemorrhage — have suction and adrenaline ready); histology + IHC (chromogranin+, synaptophysin+, Ki-67 <5%)"},
  ...
  management: {
    ...
    surgical: [
      ...
      {name:"Sleeve lobectomy", when:"Central endobronchial TC/AC; preserves additional lung parenchyma vs pneumonectomy", notes:"Bronchial sleeve resection + re-anastomosis; TSV (tumor-sparing vascular resection) if PA involvement"},
  ...
  technique: {
    ...
    prep: [
      "Double-lumen ET tube; lateral decubitus",
      "Posterolateral thoracotomy (VATS sleeve increasingly performed in specialist centers)"
    ],
    steps: [
      {n:1, t:"Hilar dissection", d:"Expose and control pulmonary artery and veins of affected lobe; divide vessels"},
      {n:2, t:"Bronchial assessment", d:"Identify exact bronchial extent of tumor with frozen section at margins; plan resection level"},
      {n:3, t:"Proximal bronchial division", d:"Divide main bronchus proximal to tumor with ≥5mm clearance (frozen section negative margin)"},
      {n:4, t:"Distal bronchial division", d:"Divide remaining lobar bronchi; ensure all tumor removed"},
    ...
    pearls: [
      "Bronchoscopic biopsy of central carcinoid: very vascular — have suction, adrenaline, and bronchial blocker ready for hemorrhage",
      "Carcinoid syndrome: somatostatin analogue pre-op (octreotide) to prevent carcinoid crisis during anesthesia",
  ...
  guidelines: [
    ...
    {src:"WHO Classification of Tumors of the Lung 2021"}
  ],
  pearls: [
  ...
  mistakes: [
    "Biopsying highly vascular central carcinoid without hemorrhage preparation — significant bleeding risk",
