...
window._TMP_HPB = [
{
  ...
  keypoints:[
    "80% mild (interstitial); 20% severe (necrotising) — mortality up to 30% in infected necrotising pancreatitis",
  ...
  differentials:["Perforated peptic ulcer","Acute cholecystitis","Mesenteric ischaemia","Aortic dissection","Inferior MI"],
  mnemonics:[{name:"GET SMASHED",text:"Gallstones, Ethanol, Trauma, Steroids, Mumps, Autoimmune, Scorpion sting, Hyperlipidaemia/Hypercalcaemia, ERCP, Drugs"}],
  overview:{
  ...
  diagnosis:{
    ...
    examination:["Epigastric tenderness ± guarding","Grey-Turner sign (flank bruising) — haemorrhagic AP","Cullen sign (periumbilical bruising) — haemorrhagic AP","Fever, tachycardia if SIRS","Absent bowel sounds (ileus)"],
    investigations:[
      ...
      {name:"FBC, CRP",role:"CRP >150 at 48 h predicts severity; WBC elevated in SIRS"},
      {name:"LFTs, bilirubin",role:"ALP/bilirubin rise suggests gallstone aetiology"},
      {name:"Serum calcium, triglycerides",role:"Exclude hypercalcaemia and hypertriglyceridaemia as cause"},
      {name:"US abdomen",role:"First-line: identifies gallstones, CBD dilation; poor pancreas visualisation in AP"},
  ...
  scoring:[
    {name:"Ranson's Criteria",items:["On admission: age >55, WBC >16, glucose >11, LDH >350, AST >250","At 48 h: haematocrit fall >10%, BUN rise >1.8, Ca <2, PaO2 <60, base deficit >4, fluid >6L","Score ≥3 = severe; mortality 15–20% with score 5–6"]},
  ...
  management:{
    ...
    medical:["Antibiotics NOT routine; use only for infected necrosis (meropenem or imipenem — good pancreatic penetration)","Prophylactic antibiotics do NOT reduce mortality or infection rate in sterile necrosis","PPI/H2RA for stress ulcer prophylaxis","DVT prophylaxis (LMWH) once haemorrhage excluded"],
    surgical:[
      ...
      {name:"Necrosectomy (step-up approach)",when:"Infected necrotising pancreatitis confirmed on CT or FNA; delay at least 4 weeks for demarcation",notes:"Step-up: percutaneous drain → minimally invasive retroperitoneal debridement (VARD/MIPD) → open if failed"},
      {name:"Open necrosectomy",when:"Failed minimally invasive approach; haemorrhage; bowel fistula",notes:"High morbidity; laparostomy may be required"}
    ]
  },
  technique:{
    ...
    pearls:["Infected necrosis: FNA or CT features (gas bubbles in collection) — do not delay treatment if gas present","Haemorrhage from pseudoaneurysm: interventional radiology embolisation first-line","Late pseudocyst (>4 cm, symptomatic): endoscopic cystogastrostomy preferred"]
  },
...
},
{
  ...
  overview:{
    ...
    pathophysiology:"Cystic duct obstruction → bile stasis → mucosal injury by concentrated bile salts → secondary bacterial infection (E. coli, Klebsiella, Enterococcus) → wall oedema, ischaemia, necrosis if untreated.",
    classification:[
      ...
      {label:"Grade III (Severe)",note:"Organ dysfunction (cardiovascular, neurological, respiratory, renal, hepatic, haematological)"}
    ]
  },
  diagnosis:{
  ...
  technique:{
    ...
    prep:["General anaesthesia, supine or French position","4-port technique: umbilical 10 mm, epigastric 5 mm, two right hypochondrial 5 mm","30° laparoscope; patient in reverse Trendelenburg, left tilt"],
    steps:[
      ...
      {n:5,t:"Dissect gallbladder from liver bed",d:"Hook diathermy along avascular plane; haemostasis; retrieve in bag"},
...
},
{
  ...
  overview:{
    ...
    pathophysiology:"Biliary obstruction → bile stasis → bacterial overgrowth (E. coli 50%, Klebsiella, Enterococcus, Bacteroides) → bacteraemia and endotoxaemia → SIRS → shock.",
    classification:[
  ...
  diagnosis:{
    ...
    investigations:[
      {name:"FBC",role:"WBC elevated; neutrophilia; thrombocytopenia in severe disease"},
      ...
      {name:"US abdomen",role:"CBD dilation (>6 mm or >8 mm post-cholecystectomy) ± stone; identifies aetiology"},
  ...
  criteria:{
    ...
    items:[
      ...
      {k:"C — Imaging",v:"Biliary dilation; or evidence of aetiology on imaging"},
  ...
  management:{
    ...
    medical:["IV antibiotics: piperacillin-tazobactam (Grade II/III); cefuroxime + metronidazole (Grade I)","Duration: 4–7 days after decompression for uncomplicated; longer if bacteraemia","Antifungals if Candida on cultures or immunocompromised"],
    surgical:[
      ...
      {name:"Endoscopic ultrasound-guided biliary drainage (EUS-BD)",when:"Failed ERCP; growing evidence for choledochoduodenostomy or hepaticogastrostomy",notes:"Requires expert centre"},
  ...
  technique:{
    ...
    steps:[
      ...
      {n:2,t:"Cholangiogram",d:"Inject contrast gently (high pressure → bacteraemia); identify filling defects, strictures, dilation"},
    ...
    pearls:["Decompress first in Grade III — even simple stent or drain is life-saving","Avoid overfilling bile duct with contrast in active cholangitis — worsens bacteraemia","Cholecystectomy after resolution — typically within same admission for stones"]
  },
  guidelines:[{src:"Tokyo Guidelines 2018 (TG18)"},{src:"ESGE Guideline on CBD Stones 2019"},{src:"BSG Guideline on ERCP 2020"}],
  pearls:["Grade III: resuscitate + urgent decompression within 12 h — do not wait for full stabilisation","Blood cultures before antibiotics — changes therapy in 30% of cases","MRCP before ERCP avoids unnecessary endoscopy if CBD stone not confirmed","After successful ERCP: interval cholecystectomy reduces recurrent cholangitis from 20% to <1%"],
  mistakes:["Diagnosing only on Charcot's triad — 50% do not have all three features","Delaying decompression in Grade III for further investigation","High-pressure contrast injection in active cholangitis — bacteraemic shock","Not performing cholecystectomy after resolution — 20% recurrence within 1 year"]
},
{
  ...
  differentials:["Cholangiocarcinoma (ICC)","Hepatic metastases","Hepatic haemangioma","Focal nodular hyperplasia","Hepatic adenoma"],
  ...
  diagnosis:{
    history:["Often asymptomatic until advanced — detected on surveillance","RUQ pain, weight loss, anorexia (advanced)","Background cirrhosis symptoms: ascites, jaundice, encephalopathy","Paraneoplastic: hypoglycaemia, erythrocytosis, hypercalcaemia"],
  ...
  management:{
    ...
    surgical:[
      {name:"Hepatic resection",when:"BCLC 0/A; single tumour; no portal hypertension; adequate future liver remnant (FLR >20–30%)",notes:"Anatomical resection preferred; FLR assessment by volumetry; portal vein embolisation if FLR borderline"},
      {name:"Liver transplantation",when:"Milan criteria: single ≤5 cm or ≤3 nodules each ≤3 cm, no PVI, no metastases — curative for HCC and cirrhosis",notes:"Bridge therapy (RFA/TACE) to prevent dropout while awaiting transplant; expanded criteria (UCSF, Up-to-7) at some centres"},
      {name:"Radiofrequency ablation (RFA)",when:"BCLC 0/A; ≤3 cm; not surgical candidate; or combined with resection for additional nodules",notes:"Percutaneous, laparoscopic, or intraoperative; 5-year survival 50–70% for small tumours"},
      ...
      {name:"TACE (trans-arterial chemoembolisation)",when:"BCLC B (intermediate); bridge to transplant; can downstage to Milan",notes:"Conventional TACE (Lipiodol + doxorubicin) or DEB-TACE; repeat every 6–8 weeks; Child-Pugh A–B only"},
      {name:"TARE / SIRT (radioembolisation)",when:"Portal vein invasion (BCLC C); failed TACE; downstaging; Child-Pugh A",notes:"Y-90 microspheres; tumour absorbed dose >200 Gy → tumour necrosis"}
    ]
  },
  technique:{
    title:"Right Hepatectomy for HCC",
    prep:["CT volumetry: FLR must be ≥20% (healthy liver) or ≥40% (cirrhotic)","Portal vein embolisation if FLR borderline (wait 4–6 weeks)","ICG clearance test (especially in Asian centres) — R15 <14% required","Patient supine; epidural analgesia"],
    steps:[
      {n:1,t:"Incision",d:"Rooftop (chevron) or J-shaped; thoracoabdominal if large right lobe tumour"},
      {n:2,t:"Mobilisation",d:"Divide right triangular and coronary ligaments; expose retrohepatic IVC"},
      ...
      {n:5,t:"Parenchymal transection",d:"CUSA/harmonic scalpel along Cantlie's line (Makuuchi technique); maintain CVP <5 cmH2O; Pringle manoeuvre (intermittent) if bleeding"},
      {n:6,t:"Right hepatic vein division",d:"Staple or suture right hepatic vein; check haemostasis; biliary leak test"},
      {n:7,t:"Closure",d:"Drain placement; close in layers"}
    ],
    pearls:["Pringle manoeuvre: Hepatoduodenal ligament clamp; limit to 15 min continuous or 30 min cumulative in cirrhosis","Keep CVP <5 cmH2O during transection — reduces blood loss","Always mark resection line with intraoperative US before cutting","R0 margin ≥1 mm — recurrence correlates with margin status"]
  },
...
},
{
  ...
  diagnosis:{
    ...
    investigations:[
      ...
      {name:"ERCP",role:"Therapeutic: direct visualisation + sphincterotomy + stone extraction; reserve for high-probability cases or when therapy planned"},
...
},
{
  ...
  differentials:["Ampullary carcinoma (better prognosis)","Distal cholangiocarcinoma","Duodenal carcinoma","Autoimmune pancreatitis (IgG4)","Pancreatic neuroendocrine tumour"],
  ...
  overview:{
    definition:"Malignant tumour arising from ductal epithelium of the pancreas; 90% are ductal adenocarcinomas.",
    ...
    pathophysiology:"KRAS mutation (>90%) → CDKN2A, SMAD4, TP53 inactivation → unchecked proliferation; desmoplastic stroma impairs drug delivery; perineurial invasion → pain; early haematogenous and lymphatic spread.",
    classification:[
  ...
  diagnosis:{
    history:["Painless progressive jaundice (head)","Weight loss, anorexia, cachexia","Dull epigastric/back pain (body/tail — late)","New-onset diabetes (recent, unexplained)","Steatorrhoea (exocrine insufficiency)","Thromboembolic events (Trousseau syndrome)"],
  ...
  criteria:{
    ...
    items:[
      {k:"Resectable",v:"No arterial tumour contact (SMA, celiac, common hepatic); SMV/PV ≤180° contact without contour irregularity"},
  ...
  scoring:[],
  management:{
    conservative:["Biliary decompression: ERCP + stent (metal preferred for resectable) before Whipple if jaundice","Nutritional support; creon (pancreatic enzyme replacement)","Pain management: coeliac plexus block for intractable pain","Palliative biliary bypass (hepaticojejunostomy) for unresectable with jaundice"],
    ...
    surgical:[
      {name:"Pancreaticoduodenectomy (Whipple)",when:"Resectable pancreatic head/neck/uncinate tumours; R0 intent",notes:"Standard or pylorus-preserving; PV/SMV resection if involved (segment resection + reconstruction); drain amylase day 3 to predict POPF"},
      {name:"Distal pancreatectomy ± splenectomy",when:"Body/tail tumours; R0 margins; no major vessel involvement",notes:"RAMPS (radical antegrade modular pancreatosplenectomy) for oncological clearance; minimally invasive approach increasingly used"},
      {name:"Total pancreatectomy",when:"Multifocal disease; positive pancreatic neck margin; IPMN with synchronous invasive cancer throughout",notes:"Obligate IDDM + exocrine insufficiency; islet cell autotransplantation at specialist centres"},
  ...
  technique:{
    ...
    prep:["Pancreas protocol CT confirms resectability","Biliary stenting only if obstructive jaundice with cholangitis or bilirubin >250; otherwise no pre-op stent","Bowel prep not required; epidural analgesia","High-volume centre (≥20/year associated with lower mortality)"],
    steps:[
      {n:1,t:"Exploration and staging",d:"Laparotomy; assess for peritoneal disease, liver metastases, fixation to major vessels"},
      {n:2,t:"Kocher manoeuvre",d:"Mobilise duodenum and pancreatic head off IVC; assess SMA/PV involvement from right"},
      ...
      {n:6,t:"Divide pancreatic neck",d:"Ensure frozen section R0; control main pancreatic duct; haemostasis"},
    ...
    pearls:["No-touch technique: early ligation of SMV tributaries reduces tumour embolisation","Pancreaticojejunostomy leak (POPF): drain amylase day 3; Grade B/C — early CT, drain management","Delayed gastric emptying (most common complication, 30%): prokinetics, NG suction","Aberrant right hepatic artery from SMA — identify before dividing GDA"]
  },
  ...
  mistakes:["Proceeding to Whipple without adequate staging CT (pancreas protocol)","Overlooking aberrant right hepatic artery — injury → hepatic ischaemia","Pre-op biliary stenting routinely — increases ERCP-related complications and wound infection","Not checking drain amylase day 3 — misses early POPF diagnosis"]
},
{
  ...
  keypoints:[
    ...
    "Triad: recurrent or constant abdominal pain + exocrine insufficiency (steatorrhoea) + endocrine insufficiency (diabetes)",
    "Pain management: stepwise — analgesics → coeliac plexus block → endoscopic drainage → surgery",
    "Total pancreatectomy with islet autotransplantation (TPIAT) for refractory pain with preserved islet mass"
  ],
  differentials:["Pancreatic ductal adenocarcinoma (mass-forming)","Autoimmune pancreatitis (IgG4)","Pancreatic pseudocyst","Groove pancreatitis","Mesenteric ischaemia"],
  ...
  overview:{
    definition:"Chronic inflammatory disease of the pancreas characterised by irreversible parenchymal fibrosis and loss of exocrine and endocrine function.",
  ...
  diagnosis:{
    history:["Recurrent or continuous epigastric/back pain — may decrease as gland burns out","Weight loss, malnutrition","Steatorrhoea: pale, bulky, offensive stools (fat malabsorption)","Diabetes mellitus (pancreatogenic — brittle, labile)","History of heavy alcohol use and/or smoking"],
    ...
    investigations:[
      ...
      {name:"Faecal elastase-1",role:"<200 μg/g stool = exocrine insufficiency; <100 = severe; low specificity for mild disease"},
      {name:"72-hour faecal fat",role:"Gold standard for malabsorption; >7 g/day = steatorrhoea; cumbersome"},
  ...
  scoring:[],
  management:{
    conservative:["Complete alcohol and smoking cessation (most important — slows progression)","Pancreatic enzyme replacement therapy (PERT): creon 25 000–80 000 units with each meal; reduces steatorrhoea, improves nutrition","Fat-soluble vitamin supplementation (A, D, E, K)","Diabetes: insulin (avoid sulphonylureas — risk of hypoglycaemia in brittle diabetes)","Nutritional support: MCT-enriched diet; nasojejunal feeding if severe malnutrition"],
    medical:["Analgesia step-up: paracetamol → NSAIDs → weak opioids → strong opioids (tramadol, morphine)","Pregabalin/gabapentin for neuropathic component","Antioxidants (vitamin C, E, selenium): limited evidence","Octreotide: reduces ductal pressure; limited clinical benefit","Coeliac plexus block (EUS-guided): temporary relief; more effective in alcoholic CP (70% respond)"],
    surgical:[
      ...
      {name:"TPIAT (Total Pancreatectomy + Islet Autotransplantation)",when:"Refractory pain; small duct disease not amenable to drainage; PRSS1/SPINK1 mutations; before diabetes develops",notes:"Pain-free in 40–70%; insulin-independent in 30–40%; specialist centres only"}
    ]
  },
  technique:{
    title:"Frey Procedure",
    prep:["MRCP confirms dilated duct and enlarged head","EUS-FNA if head mass to exclude malignancy","Nutritional optimisation pre-op; glucose control"],
    steps:[
      {n:1,t:"Exposure",d:"Kocher manoeuvre; enter lesser sac; expose pancreas"},
  ...
  pearls:["Faecal elastase is the simplest screening test for exocrine insufficiency — treat if <200 μg/g","PERT: 50 000 units lipase per meal minimum — underdosing is common","Coeliac plexus block: 70% short-term pain relief in alcoholic CP; not as good as surgery long-term (ESCAPE trial)","Pancreatogenic diabetes: insulin required; avoid sulphonylureas; prone to hypoglycaemia"],
  mistakes:["Under-dosing pancreatic enzyme replacement — patient remains malnourished","Not screening for and treating pancreatogenic diabetes","Proceeding to surgery without excluding malignancy (EUS-FNA, CA19-9) in head mass","Delaying surgery in favour of repeated endoscopic attempts — surgery more durable (ESCAPE/EORTC trials)"]
}
];
