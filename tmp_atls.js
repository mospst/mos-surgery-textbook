...
// 4 entries: primary survey, hemorrhagic shock, spinal trauma, trauma airway
const ATLS_DISEASES = [

{
  ...
  flagship: false,
  hero: "X-ABCDE: X = eXsanguinating external hemorrhage controlled first (tourniquet/wound packing), then A–Airway, B–Breathing, C–Circulation, D–Disability, E–Exposure. Used in PHTLS, TCCC, and UK trauma courses. ATLS 10/11 uses the equivalent <C>ABCDE notation where <C> = catastrophic hemorrhage pre-step.",
  keypoints: [
    "X-ABCDE: X = eXsanguinating/external hemorrhage (tourniquet, wound packing) BEFORE airway — same concept as ATLS <C>ABCDE",
    "Notation: PHTLS/TCCC/UK courses = X-ABCDE; ATLS 10/11 = <C>ABCDE (angle brackets = pre-step before formal survey); both mean hemorrhage first",
  ...
  mnemonics: [
    { name: "X-ABCDE vs <C>ABCDE", text: "X-ABCDE (PHTLS/TCCC/UK): X = eXsanguinating hemorrhage; C retains original meaning = Circulation. ATLS <C>ABCDE: same concept, angle brackets = pre-step. Both = hemorrhage control FIRST." },
    { name: "Reversible causes of traumatic arrest (4H+4T)", text: "Hypoxia, Hypovolemia, Hypothermia, H+ (acidosis) | Tension PTX, Tamponade, Toxins, Thromboembolism" },
    { name: "GCS", text: "Eyes 1–4 (None/Pain/Voice/Spontaneous), Verbal 1–5 (None/Sounds/Words/Confused/Oriented), Motor 1–6 (None/Extension/Flexion/Withdrawal/Localize/Obeys). Min 3, Max 15. Severe TBI ≤8." }
  ],
  overview: {
    definition: "The ATLS primary survey is a structured simultaneous assessment and resuscitation protocol for trauma patients. The 11th edition (2023) prioritises Catastrophic external hemorrhage control before Airway management — the C-ABCDE sequence. Life-threatening conditions are identified and treated in order of immediacy.",
    epidemiology: "Trauma is the leading cause of death in ages 1–44 worldwide. Hemorrhage accounts for 30–40% of trauma deaths, of which 25–35% are preventable with early intervention. The golden hour concept underpins ATLS: early systematic assessment prevents the lethal triad of coagulopathy, hypothermia, and acidosis.",
    pathophysiology: "Hemorrhagic shock: loss of circulating volume → decreased preload → reduced cardiac output → impaired organ perfusion → cellular hypoxia → anaerobic metabolism → lactic acidosis. Concurrent hypothermia impairs coagulation (enzymes dysfunctional below 35°C). Dilutional coagulopathy from crystalloid resuscitation worsens hemostatic failure. The lethal triad (coagulopathy + hypothermia + acidosis) is self-perpetuating.",
    classification: [
      "Class I hemorrhagic shock: <15% blood loss (<750mL); normal HR/BP/RR; no treatment beyond fluid",
  ...
  diagnosis: {
    history: [
      "Mechanism of injury: blunt (velocity, deceleration) vs. penetrating (GSW vs. stab — trajectory, caliber)",
    ...
    examination: [
      "C: Expose and control all external compressible hemorrhage — tourniquet, wound packing, direct pressure",
      ...
      "C: Assess pulse rate + quality; skin color, temperature, capillary refill; 2 large-bore IVs + bloods; FAST; pelvic spring test (once only)",
    ...
    investigations: [
      { name: "FAST / extended FAST (eFAST)", role: "Pericardial window + 4 abdominal windows + bilateral pleural — done during 'C'; sensitive for hemoperitoneum >200mL and hemopneumothorax" },
      { name: "Trauma series: CXR + AP pelvis", role: "Identify pneumothorax, hemothorax, rib fractures, pelvic ring disruption — often done simultaneously during resuscitation" },
      ...
      { name: "CBC, coagulation (incl. TEG/ROTEM), crossmatch, urine hCG", role: "Baseline hematology; TEG/ROTEM guides targeted transfusion (FFP vs. cryoprecipitate vs. platelets); hCG in all females" },
      { name: "CT whole body (pan-scan)", role: "After primary survey + initial stabilization — not for hemodynamically unstable patients. Gold standard for injury identification" }
    ]
  },
  criteria: {
    title: "ATLS 11 — Immediate Life Threats (treat during primary survey)",
    items: [
      { k: "C — Catastrophic hemorrhage", v: "Tourniquet for limb; wound packing + direct pressure for junctional. Target SBP 80–90 (no TBI); TXA within 3h of injury" },
      ...
      { k: "B — Massive hemothorax", v: "≥1500mL on drain insertion → thoracotomy if ongoing >200mL/h for 2–4h" },
      ...
      { k: "Permissive hypotension target (no TBI)", v: "SBP 80–90 mmHg until surgical hemostasis achieved; do NOT target normotension with fluids" },
  ...
  management: {
    conservative: [
      ...
      "Analgesia: IV ketamine (0.2–0.5mg/kg bolus) preferred in trauma — analgesic + maintains BP; avoid opioids if hemodynamically unstable",
      "Non-compressible hemorrhage: REBOA (Resuscitative Endovascular Balloon Occlusion of the Aorta) zone I or III as bridge to surgical control"
    ],
    medical: [
      "Tranexamic acid (TXA): 1g IV over 10 min within 3h of injury + 1g over 8h; reduces mortality from hemorrhage (CRASH-2 trial); do NOT give after 3h (increases thrombosis risk)",
      ...
      "Calcium supplementation: ionized calcium falls with massive transfusion (citrate chelation); give 10mL 10% calcium chloride per 4 units pRBC",
      "Vasopressors: noradrenaline for neurogenic shock (not hypovolemic); vasopressin 0.03 units/min for catecholamine-refractory shock"
    ],
    surgical: [
      { name: "Damage control resuscitation (DCR)", when: "Hemorrhagic shock class III–IV; coagulopathy; hypothermia; acidosis", notes: "Prioritise hemostasis over anatomy restoration. Avoid crystalloid — balanced blood product resuscitation (1:1:1). Correct lethal triad before definitive repair." },
      { name: "Damage control surgery (DCS)", when: "Life-threatening hemorrhage or contamination; physiologically exhausted patient (pH <7.2, temp <35°C, coag failure)", notes: "Stage 1: abbreviated surgery — hemostasis + contamination control + temporary closure. Stage 2: ICU resuscitation 24–48h. Stage 3: planned relook + definitive repair." },
  ...
  technique: {
    ...
    prep: [
      ...
      "Trauma activation: level I (highest) for hemodynamic instability, airway compromise, GCS ≤8, penetrating neck/torso",
      "Equipment ready: RSI drugs drawn, chest drain trays, FAST machine, MTP cooler"
    ],
    steps: [
      { n: 1, t: "X — eXsanguinating hemorrhage", d: "Tourniquet applied proximal to wound (limb) — note time. Wound packing + direct pressure for junctional bleed. Call for MTP if suspected class III–IV. (ATLS notation: <C> pre-step; PHTLS/UK: X step)" },
      { n: 2, t: "A — Airway", d: "Jaw thrust + inline C-spine stabilization. Clear airway. Assess: phonation, stridor, obstruction. GCS ≤8 or obstructed → RSI (ketamine 1.5mg/kg + suxamethonium 1.5mg/kg). Video laryngoscopy preferred." },
      ...
      { n: 5, t: "D — Disability", d: "GCS (E+V+M). Pupils: size, symmetry, reactivity. AVPU. Blood glucose (treat hypoglycemia). Lateralizing signs → urgent neurosurgical review." },
      ...
      { n: 7, t: "Adjuncts", d: "After primary survey: ECG + SpO₂ + end-tidal CO₂ (if intubated). Urinary catheter (if no urethral injury). NGT/OGT. Portable CXR + pelvis AXR. Decision: CT pan-scan (if stable) or direct to theater." }
    ],
    pearls: [
      "ATLS 11 key change: Catastrophic hemorrhage control is STEP 1 — tourniquet first, then manage airway",
      "Never remove a tourniquet in the trauma bay — document time of application; reassess in theater",
  ...
  guidelines: [
    ...
    { src: "EAST — Practice Management Guidelines for Hemorrhagic Shock", url: "https://www.east.org/education/practice-management-guidelines" },
    { src: "CRASH-2 trial — TXA in trauma hemorrhage (Lancet 2010)", url: "https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(10)60835-5/fulltext" }
  ],
  pearls: [
    "ATLS 11: C-ABCDE — Catastrophic hemorrhage is now Step 1, before airway",
  ...
  mistakes: [
    "Targeting normal BP with crystalloid in hemorrhagic shock — worsens coagulopathy and hypothermia",
    "Giving TXA after 3 hours from injury — significantly increases mortality",
    "Removing tourniquet in resus bay — do not; only reassess in theater under controlled conditions",
...

{
  ...
  dept: "trauma",
  name: "Hemorrhagic Shock (ATLS 11 Classification)",
  latin: "Shock haemorrhagicus",
  organ: "Cardiovascular system — acute circulatory failure",
  severity: "high",
  tags: ["ATLS","hemorrhagic shock","transfusion","MTP","permissive hypotension","TXA"],
  hero: "ATLS 11th ed. revises shock classification to 4 classes based on HR, SBP, RR, GCS, and base deficit. Hemorrhage is the leading preventable cause of trauma death. Treatment = source control + damage control resuscitation (1:1:1 blood products, not crystalloid).",
  keypoints: [
  ...
  differentials: [
    ...
    "Cardiogenic shock: hypotension + elevated JVP + pulmonary edema; cardiac contusion or pre-existing",
  ...
  overview: {
    definition: "Hemorrhagic shock is inadequate tissue perfusion due to acute blood loss. ATLS 11th edition classifies it into 4 classes based on estimated volume loss, hemodynamic parameters, neurological status, and metabolic markers (base deficit, lactate). Hemorrhage accounts for 30–40% of trauma deaths, of which 25–35% are preventable.",
    epidemiology: "1.35 million trauma deaths/year worldwide (WHO). 80% of intraoperative deaths from hemorrhage are preventable. Penetrating trauma causes hemorrhage more rapidly than blunt; retroperitoneal hemorrhage from pelvic fractures can be massive and occult. MTP activation within 30 minutes of arrival improves survival.",
    pathophysiology: "Acute blood loss → decreased venous return → reduced preload → fall in cardiac output → compensatory tachycardia and vasoconstriction → maintained SBP until >30% volume lost. Progressive oxygen debt → cellular hypoxia → anaerobic metabolism → lactic acidosis → mitochondrial dysfunction. Hypothermia impairs coagulation factors and platelet function. Hemodilution from crystalloid resuscitation worsens coagulopathy. The lethal triad (acidosis + hypothermia + coagulopathy) becomes self-perpetuating without correction.",
    classification: [
  ...
  diagnosis: {
    history: [
      "Mechanism: penetrating (rate of loss faster) vs. blunt (occult hemorrhage common)",
    ...
    examination: [
      ...
      "Identify hemorrhage source: external wounds, abdominal tenderness (FAST), pelvic instability, long bone fractures (femur = 1.5L, pelvis = 3–5L)"
    ],
    investigations: [
      ...
      { name: "CBC, coagulation screen, fibrinogen, crossmatch", role: "Baseline; repeat every 30–60 min in active hemorrhage; fibrinogen <2g/L = cryoprecipitate" },
      { name: "eFAST", role: "Identifies hemoperitoneum, hemothorax, tamponade during primary survey" },
      { name: "CT angiogram (if stable)", role: "Identifies source for angioembolization (pelvic, hepatic, splenic bleeding)" }
    ]
  },
  criteria: {
    title: "Massive Transfusion Protocol (MTP) Activation Criteria",
    items: [
      { k: "Clinical: shock index >1 (HR/SBP)", v: "Shock index >1.0 = significant hemorrhage; >1.8 = severe; triggers MTP consideration" },
      { k: "ABC score ≥2", v: "Assessment of Blood Consumption: penetrating mechanism (1) + HR >120 (1) + SBP <90 (1) + +FAST (1); ≥2 = MTP activated" },
      { k: "TASH score ≥16", v: "Trauma-Associated Severe Hemorrhage score; multivariate; >99% probability MTP needed" },
      { k: "Clinical judgement", v: "Class III–IV hemorrhagic shock + non-compressible hemorrhage = immediate MTP activation regardless of score" },
  ...
  management: {
    conservative: [
      "Permissive hypotension: SBP 80–90 mmHg until surgical hemostasis (ATLS 11) — avoids coagulopathy from overresuscitation; CONTRAINDICATED in TBI",
      "Hemostatic resuscitation: blood products first (avoid crystalloid); warm all products (Level 1 rapid infuser)",
      "External hemorrhage: tourniquet (limb) + wound packing with hemostatic gauze (junctional) + direct pressure — do not remove until theater"
    ],
    medical: [
      ...
      "Calcium chloride 10mL 10% per 4 units pRBC: prevents ionized hypocalcemia from citrate in blood products — essential in massive transfusion",
    ...
    surgical: [
      { name: "Source control", when: "Compressible hemorrhage (external) — tourniquet + packing; non-compressible (solid organ, pelvic, retroperitoneal) — surgery or angioembolization", notes: "REBOA (zone I for solid organ/abdominal aorta; zone III for pelvic) as bridge to surgery in arrest/peri-arrest" },
      { name: "Damage control surgery", when: "Class III–IV shock; physiological exhaustion; lethal triad", notes: "Abbreviated surgery: hemostasis + contamination control + temporary closure. Definitive repair only after physiological restoration in ICU (24–48h)" },
      { name: "Pelvic packing / angioembolization", when: "Pelvic ring fracture with hemodynamic instability", notes: "External fixator / pelvic binder → pre-peritoneal packing (PPP) + bilateral iliac angioembolization for arterial bleeding (posterior — superior gluteal; anterior — obturator)" }
    ]
  },
  technique: {
    title: "Massive Transfusion Protocol — Activation to Administration",
    prep: [
      "MTP cooler: prepared in blood bank with 6 pRBC + 6 FFP + 1 pool platelets (UK standard) or 10+10+2 in high-demand centers",
      "Allocate team member solely to documentation of products given + timings",
      "Senior surgeon + anesthetist to bedside; OR notified to prepare emergency theater"
    ],
    steps: [
      ...
      { n: 5, t: "Calcium supplementation", d: "10mL calcium chloride 10% IV after every 4 units of pRBC — prevent ionized hypocalcemia." },
      { n: 6, t: "Monitor endpoints", d: "Lactate (target <2), BE (target >−6), temperature (target >36°C), pH (>7.35), SpO₂. Reassess hemorrhage source every 15 min." },
      { n: 7, t: "Deactivate MTP", d: "When hemostasis achieved + hemodynamic stability + TEG/ROTEM normalizing. Switch to standard hematology review." }
    ],
    pearls: [
      "Give TXA before starting surgery — antifibrinolysis is most effective before surgical trauma activates fibrinolysis",
      "Calcium is the forgotten part of MTP — ionized hypocalcemia causes cardiac depression and coagulopathy",
  ...
  mistakes: [
    ...
    "Not giving calcium during MTP — ionized hypocalcemia impairs cardiac contractility and coagulation"
  ]
},

{
  ...
  hero: "ATLS 11 replaces 'full spinal immobilization' with 'spinal motion restriction' (SMR). NEXUS criteria and Canadian C-Spine Rule guide C-spine clearance. Complete vs. incomplete cord syndromes have very different prognoses. Neurogenic shock = hypotension + bradycardia — must NOT be treated as hemorrhagic shock.",
  keypoints: [
  ...
  differentials: [
    "Neurogenic shock vs. hemorrhagic shock (tachycardia vs. bradycardia; warm vs. cold peripheries)",
  ...
  overview: {
    definition: "Traumatic spinal cord injury (tSCI) results from fracture-dislocation, burst fracture, or ligamentous disruption causing cord compression, contusion, or transaction. ATLS 11th edition updates management to spinal motion restriction (SMR) rather than full immobilization, guided by validated clinical clearance tools.",
  ...
  diagnosis: {
    history: [
      ...
      "Immediate neurological symptoms at scene vs. delayed (lucid interval then deterioration = evolving cord edema or hematoma)",
    ...
    investigations: [
      ...
      { name: "MRI spine", role: "Gold standard for cord, disc, ligament, and epidural hematoma assessment; essential for incomplete cord injury, neurological deterioration, or clinical suspicion without CT findings" },
  ...
  criteria: {
    ...
    items: [
      ...
      { k: "Spinal motion restriction — ATLS 11", v: "SMR (not full immobilization): collar for suspected C-spine; firm stretcher; log-roll. Remove collar after clearance — prolonged collars cause pressure sores, ↑ICP, aspiration risk" },
      { k: "Neurogenic shock management", v: "MAP target 85–90 mmHg for 7 days post-injury (NASCIS III). Vasopressors (noradrenaline) + atropine for bradycardia. Do NOT give large fluid boluses — causes pulmonary edema" }
    ]
  },
  scoring: ["asia"],
  management: {
    conservative: [
      ...
      "DVT prophylaxis: LMWH within 72h of injury (not earlier due to hemorrhage risk)"
    ],
    medical: [
  ...
  technique: {
    ...
    prep: [
      "Minimum 4 staff: leader at head (maintains inline stabilization + calls movement), 3 for body",
      "Semi-rigid cervical collar applied before log-roll",
      "Transfer board / scoop stretcher prepared alongside"
    ],
    steps: [
      { n: 1, t: "Leader takes head", d: "One person at head maintains manual inline stabilization of C-spine — both hands cradle occiput and mandible. Leader counts and directs." },
    ...
    pearls: [
      ...
      "Cervical collar does NOT immobilize the C-spine — manual inline stabilization is the critical intervention",
      "Long spine boards: ATLS 11 recommends removing from transport boards quickly — prolonged use causes pressure sores",
      "Pediatric C-spine: children have relatively large heads — padding under torso (not head) needed to maintain neutral alignment"
    ]
  },
  guidelines: [
    { src: "ATLS 11th Edition — American College of Surgeons, 2023", url: "https://www.facs.org/quality-programs/trauma/atls/" },
  ...
  pearls: [
    "ATLS 11: 'spinal motion restriction' not 'immobilization' — remove collar after clearance to prevent pressure sores and ↑ICP",
  ...
  mistakes: [
    "Treating neurogenic shock as hemorrhagic shock — fluid overload causes pulmonary edema; use vasopressors",
...

{
  ...
  hero: "ATLS 11 airway algorithm: attempt oxygenation first → RSI (video laryngoscopy preferred) → if failed → supraglottic airway device (LMA) → if CICO → surgical cricothyroidotomy (scalpel-finger-bougie). C-spine inline stabilization throughout. Front-of-neck access (FONA) is the life-saving last resort.",
  keypoints: [
    ...
    "RSI in trauma: ketamine 1–2mg/kg IV (hemodynamically stable: propofol; unstable: ketamine) + suxamethonium 1.5mg/kg OR rocuronium 1.2mg/kg",
    ...
    "Nasopharyngeal airway contraindicated in confirmed/suspected base of skull fracture (CSF rhinorrhea, raccoon eyes, Battle's sign, hemotympanum)",
  ...
  differentials: [
    "Upper airway obstruction: tongue (GCS↓), blood/secretions (suction), foreign body, hematoma, edema, laryngeal fracture",
    "Difficult airway predictors: LEMON — Look (anatomy), Evaluate (3-3-2 rule), Mallampati, Obstruction, Neck mobility",
    "Burns inhalation airway: progressive edema — intubate EARLY before edema closes airway (cannot use tracheostomy in burned neck)",
    "Laryngotracheal injury: subcutaneous emphysema + dysphonia + hemoptysis — very difficult airway, prepare for surgical airway at outset"
  ],
  mnemonics: [
  ...
  overview: {
    definition: "Airway management in trauma requires establishing and maintaining a patent airway while protecting the cervical spine. ATLS 11 emphasises early recognition of airway compromise, the use of video laryngoscopy for RSI, and rapid escalation to surgical airway (cricothyroidotomy) in the CICO scenario. The 'ABCDE' A-step remains a simultaneous action with C-spine inline stabilization.",
    epidemiology: "Airway compromise is responsible for 15–30% of preventable trauma deaths. 1–3% of trauma intubations result in CICO. Predicted difficult airway in 10% of trauma patients (obesity, facial fractures, burns, blood in airway). Failed airway accounts for 28% of anesthetic deaths in trauma. Early surgical airway is life-saving; delay kills.",
    pathophysiology: "Upper airway obstruction: tongue falls back (GCS↓); blood/vomit/foreign body; edema from burns/anaphylaxis; hematoma from maxillofacial fractures or anterior neck injury. C-spine injury: neutral alignment essential during intubation — manual inline stabilization (MILS) reduces C-spine movement vs. uncontrolled laryngoscopy; removes collar but replaces with MILS. RSI drugs: ketamine maintains BP (sympathomimetic), analgesic; suxamethonium: fastest offset if intubation fails but CONTRAINDICATED in burns >48h, denervation injuries, crush, hyperkalemia.",
    classification: [
  ...
  diagnosis: {
    history: [
      ...
      "Symptoms: stridor, dysphonia, inability to swallow, progressive dyspnea",
      "Pre-hospital: oxygen given + response, suction performed, attempts at airway"
    ],
    examination: [
      "Look: agitation (hypoxia), cyanosis, facial fractures, neck hematoma, soot/singed hair (burns), subcutaneous emphysema",
      "Listen: stridor (partial obstruction), gurgling (fluid), silence (complete obstruction or apnea)",
    ...
    investigations: [
      ...
      { name: "CT neck/face/chest", role: "After stabilization: identifies laryngotracheal injury, hematoma, retropharyngeal hematoma" }
    ]
  },
  criteria: {
    ...
    items: [
      ...
      { k: "Anticipated difficult/deteriorating airway", v: "Burns, inhalation, evolving hematoma, facial fractures — intubate early before edema progresses" },
  ...
  management: {
    conservative: [
      ...
      "High-flow O₂ (15L/min via non-rebreathe mask): pre-oxygenation before RSI — 3 min normal breathing or 8 maximal breaths increases safe apnea time",
    ...
    medical: [
      "RSI — induction agent: Ketamine 1.5–2mg/kg IV (hemodynamically unstable preferred — catecholamine release maintains BP); propofol 1–2mg/kg (hemodynamically stable only); etomidate 0.3mg/kg (adrenal suppression concern in major trauma)",
      "RSI — neuromuscular blockade: Suxamethonium 1.5mg/kg IV (fastest onset/offset, ideal for RSI; CONTRAINDICATED: burns >48h, denervation, hyperkalemia, crush); Rocuronium 1.2mg/kg (alternative — reversal with sugammadex 16mg/kg available)",
      "Post-intubation sedation: propofol + fentanyl infusion; ketamine + midazolam in hemodynamically unstable"
    ],
    surgical: [
      { name: "Surgical cricothyroidotomy (scalpel-finger-bougie)", when: "CICO — failed intubation + failed oxygenation; immediate, without delay", notes: "Scalpel vertical skin incision (4cm) over CTM → stabilize larynx → horizontal stab incision through CTM (scalpel blade horizontal) → insert finger to confirm airway entry → bougie guided into trachea → railroad 6.0 cuffed ETT over bougie → inflate cuff → confirm ETCO₂. Convert to formal tracheostomy within 24–72h." },
      { name: "Fiberoptic intubation (awake)", when: "Predicted difficult airway in cooperative patient (trauma rare); suspected C5-6 fracture with incomplete SCI requiring airway", notes: "Requires patient cooperation and topical anesthesia; rarely possible in acute trauma. If time permits for stable predicted difficult airway." },
      { name: "Emergency surgical airway via neck", when: "Laryngotracheal trauma with destroyed anatomy; CICO in burns patient", notes: "Direct tracheal intubation through wound or formal tracheostomy under local anesthetic if anatomy disrupted. Involves ENT/thoracic surgeon if available." }
    ]
  },
  technique: {
    ...
    steps: [
      ...
      { n: 2, t: "Positioning", d: "Supine. C-spine inline stabilization (MILS) — remove front of collar, assistant holds head from below table. Optimal sniffing position blocked by MILS — prepare for potential difficulty." },
      { n: 3, t: "Induction", d: "Ketamine 1.5mg/kg IV push (or propofol if hemodynamically stable). Wait 30–60 seconds for LOC." },
    ...
    pearls: [
      ...
      "Ketamine is the induction agent of choice in hemodynamic instability — it maintains BP by catecholamine release",
      "Surgical airway kit must be OPEN at bedside before every RSI in trauma — not retrieved from a drawer after failure",
      "Burns: intubate EARLY — airway edema progresses rapidly and surgical airway becomes impossible through burned tissues"
    ]
  },
  guidelines: [
    { src: "ATLS 11th Edition — American College of Surgeons, 2023", url: "https://www.facs.org/quality-programs/trauma/atls/" },
  ...
  pearls: [
    ...
    "Ketamine for trauma RSI: maintains hemodynamics, analgesic, bronchodilator — preferred in shocked patient",
    "Suxamethonium CONTRAINDICATED after 48h burns, denervation, hyperkalemia, or crush injury — use rocuronium"
  ],
  mistakes: [
    ...
    "Using suxamethonium in burns (>48h), crush, or denervation — can trigger lethal hyperkalemic cardiac arrest",
    "Removing cervical collar without manual inline stabilization — not neutral C-spine alignment"
  ]
}
