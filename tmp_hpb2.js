...
window._TMP_HPB2 = [
{
  ...
  hero:"Malignant tumour of the extrahepatic bile ducts; perihilar (Klatskin) tumours account for 60–70% and are the most surgically challenging.",
  keypoints:[
  ...
  diagnosis:{
    ...
    investigations:[
      ...
      {name:"MRCP",role:"Delineate biliary anatomy; stricture morphology; ductal extent of tumour — essential for planning"},
  ...
  criteria:{
    ...
    items:[
      ...
      {k:"FLR requirement",v:"≥40% in cirrhotic or cholestatic liver; portal vein embolisation if borderline"},
  ...
  management:{
    ...
    surgical:[
      ...
      {name:"Liver transplantation for perihilar CCA",when:"Highly selected: unresectable perihilar CCA <3 cm without nodal/metastatic disease; after neoadjuvant CRT (Mayo protocol)",notes:"5-year survival 53% in selected patients; requires specialised programme"},
  ...
  technique:{
    ...
    prep:["MRCP delineates biliary anatomy","CT/PET staging excludes distant disease","PTC for biliary decompression — decompress future remnant liver first","Portal vein embolisation if FLR <40%"],
    steps:[
      ...
      {n:4,t:"Major hepatectomy",d:"Right or left hepatectomy based on Bismuth type and tumour side; preserve adequate FLR"},
    ...
    pearls:["Caudate resection is mandatory — the Achilles heel of perihilar resection; omission causes R1","PTC pre-op: drain future remnant liver, NOT the tumour side, to promote hypertrophy","Frozen section margins: if R1, extend resection — even 1 mm free margin improves survival","Portal vein embolisation allows safe major hepatectomy when FLR is inadequate"]
  },
...
},
{
  ...
  diagnosis:{
    ...
    examination:["Hepatomegaly, palpable mass (large tumour)","Jaundice (late or perihilar extension)","Cachexia (advanced)"],
    investigations:[
      ...
      {name:"MRI liver with hepatobiliary contrast",role:"Better characterisation; bile duct involvement; satellite lesions; FLR assessment"},
  ...
  criteria:{
    ...
    items:[
      ...
      {k:"LN assessment",v:"Regional LN (hepatoduodenal) not absolute contraindication; distant LN (coeliac, para-aortic) = M1"},
      {k:"Portal vein embolisation",v:"If FLR <25–40%; wait 4–6 weeks"}
    ]
  },
  scoring:[],
  management:{
    ...
    surgical:[
      ...
      {name:"Extended hepatectomy",when:"Tumour involving both lobes or perihilar extension",notes:"High morbidity; requires PVE; specialist centre"},
      {name:"Locoregional therapy",when:"Unresectable; or bridge to resection/transplant",notes:"TARE (Y-90), TACE, ablation (RFA/MWA); hepatic arterial infusion (HAI) chemotherapy at specialist centres; SBRT"}
    ]
  },
  technique:{
    title:"Major Hepatectomy for ICC with Lymphadenectomy",
    prep:["MRI defines margins and bile duct involvement","PET-CT excludes extrahepatic disease","CT volumetry ± portal vein embolisation if FLR insufficient","Molecular profiling of biopsy for actionable mutations"],
    steps:[
      ...
      {n:6,t:"Haemostasis and drain",d:"Argon beam or bipolar to raw liver surface; closed drain"}
    ],
...
},
{
  ...
  differentials:["Walled-off necrosis (WON)","Mucinous cystic neoplasm (MCN)","IPMN","Serous cystadenoma","Cystic neuroendocrine tumour"],
  mnemonics:[{name:"Pseudocyst vs WON",text:"Pseudocyst = pure fluid; WON = fluid + necrotic debris. WON: mixed density CT, history of necrotising AP. Treatment differs: pseudocyst → simple drainage; WON → necrosectomy via LAMS"}],
  overview:{
  ...
  diagnosis:{
    ...
    investigations:[
      ...
      {name:"MRI/MRCP",role:"Best for characterising content; identifies debris; communication with duct; cystic neoplasm features"},
      {name:"EUS",role:"Pre-drainage assessment; visualises vessel proximity; allows FNA; cyst fluid analysis"},
  ...
  criteria:{
    ...
    items:[
      ...
      {k:"Haemorrhage",v:"Pseudoaneurysm — interventional radiology embolisation first; then drain/surgery"},
  ...
  management:{
    ...
    surgical:[
      {name:"EUS-guided cystogastrostomy / cystoenterostomy",when:"Pseudocyst adherent to stomach or duodenum; ≥6 cm; symptomatic",notes:"EUS identifies wall, vessels; LAMS (Hot AXIOS) placed under EUS guidance; superior to surgical drainage; avoids general anaesthesia"},
...
},
{
  ...
  keypoints:[
    ...
    "Acute variceal haemorrhage: ABC, terlipressin, EBL ± TIPS (within 72 h for Child-Pugh B/C)",
  ...
  diagnosis:{
    history:["Known cirrhosis or chronic liver disease","Haematemesis or melaena (variceal bleeding)","Abdominal distension (ascites)","Confusion (hepatic encephalopathy)","Alcohol use, viral hepatitis, autoimmune disease"],
    examination:["Splenomegaly","Ascites — shifting dullness, fluid thrill","Caput medusae","Spider naevi, palmar erythema","Jaundice, gynaecomastia","Hepatic encephalopathy: asterixis, confusion"],
    investigations:[
      ...
      {name:"OGD",role:"Diagnose and classify varices (Baveno grading); diagnose portal hypertensive gastropathy"},
      ...
      {name:"LFTs, FBC, coagulation",role:"Thrombocytopenia (splenomegaly); prolonged PT; low albumin; elevated bilirubin"},
  ...
  criteria:{
    ...
    items:[
      ...
      {k:"No varices needing treatment",v:"LSM <20 kPa + platelet >150 → can avoid OGD screening"},
  ...
  management:{
    ...
    medical:["Primary prophylaxis of variceal bleeding: propranolol or carvedilol (NSBB); or EBL","Acute variceal haemorrhage: terlipressin 2 mg IV q4h × 5 days; octreotide alternative","Antibiotics (ceftriaxone 1 g/day × 7 days) routinely in acute variceal bleed — reduces bacterial translocation, SBP, mortality","Vasopressin analogues: terlipressin reduces portal pressure and controls acute bleeding in 85%"],
    surgical:[
      {name:"Endoscopic band ligation (EBL)",when:"Primary or secondary prevention of variceal bleeding; acute bleeding (first-line after pharmacotherapy)",notes:"Repeat EBL every 2–4 weeks until varices obliterated; then 6-monthly surveillance OGD"},
      ...
      {name:"Devascularisation (Sugiura) / surgical shunts",when:"Failed TIPS/EBL; TIPS anatomically impossible; extrahepatic PVT",notes:"Selective shunts (distal splenorenal — Warren): maintains portal perfusion, lower encephalopathy; rarely performed in era of TIPS"},
  ...
  technique:{
    ...
    prep:["CT: portal vein patency; hepatic vein anatomy","OGD within 12 h of acute bleed to confirm variceal source","Coagulation support: FFP, platelets; do NOT delay TIPS for correction in acute setting","GA or conscious sedation + fluoroscopy"],
    steps:[
      ...
      {n:6,t:"Variceal embolisation",d:"If variceal bleeding: coil embolisation of gastric/oesophageal varices concurrent with TIPS"}
    ],
...
},
{
  ...
  severity:"medium", tags:["liver","abscess","pyogenic","amoebic","drainage","E. coli","Klebsiella"],
  hero:"Localised collection of pus within the hepatic parenchyma; pyogenic (bacterial) in 80% of cases in Western countries; amoebic in developing world.",
  keypoints:[
    ...
    "Amoebic: Entamoeba histolytica; single large abscess (right lobe); anchovy paste aspirate; serology diagnostic; metronidazole cures 95%",
  ...
  differentials:["HCC (necrotic)","Hepatic metastasis (necrotic)","Hydatid cyst","Biloma","Hepatic haematoma"],
  mnemonics:[{name:"Liver Abscess Causes",text:"Pyogenic: Biliary, Portal (appendicitis, diverticulitis), Direct, Haematogenous, Cryptogenic. Amoebic: Entamoeba — single, right lobe, anchovy paste"}],
  overview:{
    definition:"Localised suppurative infection within the liver parenchyma, resulting in pus-filled cavity.",
    ...
    pathophysiology:"Pyogenic: biliary bacteria ascend via biliary tree (commonest route); portal spread from appendicitis/diverticulitis/IBD; direct extension; haematogenous seeding. Amoebic: E. histolytica trophozoites travel via portal vein from gut; proteolytic enzymes liquefy hepatocytes.",
    classification:[
      {label:"Pyogenic",note:"Bacterial; often polymicrobial; associated with biliary disease, diabetes, malignancy"},
      {label:"Amoebic",note:"Entamoeba histolytica; single right lobe abscess; travel or endemic exposure"},
  ...
  diagnosis:{
    history:["Fever, rigors, sweating","RUQ pain","Nausea, anorexia, weight loss","Recent biliary procedure, abdominal sepsis, dental procedure","Travel to endemic area (amoebic)","Diabetes mellitus (Klebsiella)"],
    ...
    investigations:[
      {name:"FBC, CRP, ESR",role:"Markedly elevated WBC and CRP; anaemia; elevated ESR"},
      {name:"LFTs",role:"ALP elevated >90%; bilirubin elevated if biliary cause; ALT mildly elevated"},
      {name:"Blood cultures",role:"Positive in 50%; take before antibiotics; Klebsiella bacteraemia: check eyes (endophthalmitis)"},
      ...
      {name:"Amoebic serology (ELISA)",role:"Sensitivity 92%; positive in amoebic abscess; does not distinguish active from past infection in endemic areas"},
      {name:"Aspiration (diagnostic/therapeutic)",role:"Pus: send MC&S, AFB; anchovy paste (amoebic); clear fluid (hydatid — caution — anaphylaxis)"}
    ]
  },
  criteria:{
    ...
    items:[
      ...
      {k:"Amoebic abscess",v:"Metronidazole alone effective in 95%; drain only if rupture risk, no response at 72 h, or diagnostic uncertainty"}
    ]
  },
  scoring:[],
  management:{
    conservative:["NBM initially; IV fluids","Analgesia","Physiotherapy for pleural effusion"],
    medical:["Pyogenic: IV antibiotics — piperacillin-tazobactam + metronidazole; switch to oral after clinical improvement (ciprofloxacin + metronidazole); total 4–6 weeks","Amoebic: metronidazole 750 mg TID × 10 days → luminal agent (paromomycin or diloxanide) to eradicate gut cysts","Fungal: IV antifungal (micafungin or amphotericin B) in immunocompromised"],
    surgical:[
      {name:"Percutaneous needle aspiration (PNA)",when:"Amoebic >5 cm or risk of rupture; diagnostic samples from pyogenic",notes:"Single or repeated aspirations; no drain — suitable for amoebic and small pyogenic"},
  ...
  guidelines:[{src:"WJG Guidelines: Management of Liver Abscess 2022"},{src:"AASLD Amoebic Liver Abscess 2006 (updated)"},{src:"British Infection Association: PLA Guidelines 2020"}],
  pearls:["Metronidazole cures 95% of amoebic abscesses — drain only if large (>10 cm), left lobe (rupture into pericardium), or no response","Klebsiella pneumoniae liver abscess: associated with diabetes; spread to eye (endophthalmitis) and CNS (meningitis) — screen for these","CT cluster sign (multiple coalescing small abscesses) = pyogenic — warrants aggressive drainage and biliary workup","Always look for and treat the underlying source (biliary stones, colonic pathology)"],
  mistakes:["Not treating the underlying source — recurrence inevitable","Missing metastatic Klebsiella complications (eye, brain) in Asian patients","Aspirating a hydatid cyst as a liver abscess — anaphylaxis risk; CT morphology crucial","Treating amoebic abscess with drainage alone without metronidazole — metronidazole is the definitive treatment"]
},
{
  ...
  technique:{
    ...
    steps:[
      ...
      {n:2,t:"Hepatoduodenal lymphadenectomy",d:"Clear all nodes in hepatoduodenal ligament, hepatic artery, and coeliac axis; ≥6 nodes; frozen section on suspicious nodes"},
      ...
      {n:6,t:"Closure",d:"Haemostasis; drain placement; close in layers"}
    ],
...
},
{
  ...
  differentials:["HCC","Hepatic haemangioma","FNH","Hepatic adenoma","Other metastases (breast, neuroendocrine, pancreas)"],
  ...
  overview:{
    definition:"Metastatic deposits within the liver arising from colorectal adenocarcinoma via haematogenous portal spread.",
  ...
  diagnosis:{
    ...
    investigations:[
      {name:"CEA",role:"Serial monitoring; rising CEA post-colectomy triggers imaging; correlates with tumour burden"},
      ...
      {name:"MRI liver (hepatobiliary contrast — Eovist/Primovist)",role:"More sensitive for small lesions <1 cm; characterises indeterminate lesions; biliary anatomy"},
  ...
  criteria:{
    ...
    items:[
      ...
      {k:"FLR augmentation",v:"Portal vein embolisation (PVE); ALPPS (two-stage); ablation of contralateral lesions"},
  ...
  scoring:[
    {name:"Fong Clinical Risk Score",items:["Node-positive primary tumour","Disease-free interval <12 months",">1 hepatic tumour","Largest hepatic tumour >5 cm","CEA >200 ng/mL","Score 0–2: favourable (5-yr OS 50%); Score 3–5: poor (5-yr OS 20%)"]}
  ],
  management:{
  ...
  technique:{
    ...
    steps:[
      ...
      {n:2,t:"Intraoperative US (IOUS)",d:"Systematic survey of all 8 segments; characterise all lesions; plan resection margins; identify vascular proximity"},
      {n:3,t:"Parenchymal transection",d:"Non-anatomical resection if possible — spares parenchyma; CUSA + harmonic; R0 ≥1 mm"},
      {n:4,t:"Pringle manoeuvre",d:"If bleeding; ≤30 min continuous; protect remnant — intermittent if cirrhosis"},
      {n:5,t:"Ablation of additional lesions",d:"For lesions in unfavourable positions: RFA/MWA intraoperatively under IOUS guidance"},
      {n:6,t:"Haemostasis, bile leak check",d:"Argon beam; cholangiography if duct proximity; drain if biliary injury risk"}
    ],
    pearls:["IOUS is mandatory — identifies additional lesions in 15% and changes surgical plan in 30%","R0 margin ≥1 mm = equivalent to wider margins (Pawlik 2005) — sacrifice less parenchyma","Parenchymal-sparing preserves FLR for repeat resection (recurrence in 50–70% of patients)","PVE: embolise the lobe to be resected → FLR hypertrophies 30–50% in 4–6 weeks"]
  },
