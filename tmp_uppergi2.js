...
{
  id:"boerhaave", dept:"uppergi", name:"Esophageal Perforation (Boerhaave)", latin:"Perforatio oesophagi spontanea", organ:"Esophagus",
  severity:"high", tags:["esophagus","perforation","Mackler","mediastinitis","Gastrografin","thoracotomy"],
  ...
  technique:{
    ...
    steps:[
      {n:1,t:"Left posterolateral thoracotomy (6th/7th ICS)",d:"Decompress hemothorax/empyema; peel fibrinous exudate"},
      {n:2,t:"Expose esophageal perforation",d:"Incise mediastinal pleura; expose perforation; extend longitudinal muscle tear to expose full mucosal defect"},
      ...
      {n:6,t:"Buttress",d:"Wrap with adjacent pleura, intercostal muscle, or mobilized gastric fundus; reinforces repair"}
    ],
...
},
{
  ...
  mnemonics:[{name:"RYGB vs Sleeve",text:"RYGB: Restrictive + Malabsorptive; superior metabolic; dumping risk; nutrient deficiencies; Sleeve: Restrictive only; simpler; GERD worse; less nutrition risk; weight regain more common"}],
  overview:{
  ...
  diagnosis:{
    history:["BMI ≥40 or ≥35 + T2DM/HTN/OSA/NAFLD","Failed conservative measures (diet, exercise, orlistat) for ≥6 months","No active psychiatric disorder or substance misuse","Pre-op assessment: nutritional status, vitamin levels, GERD, sleep study"],
    examination:["BMI, neck circumference (OSA risk)","GERD symptoms (sleeve may worsen)","Comorbidity assessment"],
    investigations:[
      {name:"EGD",role:"Pre-op: exclude peptic ulcer, H. pylori, Barrett's — H. pylori eradication reduces marginal ulcer risk"},
  ...
  management:{
    ...
    surgical:[
      {name:"Laparoscopic sleeve gastrectomy",when:"First-line for most patients; simpler; no anastomosis; BMI ≥35",notes:"Bougie 36–40 Fr; resect 75–80% greater curvature; staple 6 cm from pylorus; oversew staple line; leak test; GERD worsens — consider RYGB if pre-existing GERD"},
      {name:"Laparoscopic Roux-en-Y gastric bypass",when:"BMI ≥40; T2DM; GERD; failed sleeve; superior metabolic outcomes desired",notes:"Create 20 mL gastric pouch; 150 cm Roux limb; 50 cm biliopancreatic limb; antegastric antecolic; methylene blue leak test; close Petersen's and mesenteric defects"},
      {name:"Revision surgery",when:"Weight regain (30% at 5 years after SG); band slippage; GERD after sleeve",notes:"Sleeve to RYGB conversion; band removal + SG/RYGB; high complication rate; specialist center only"}
    ]
  },
  technique:{
    title:"Laparoscopic Roux-en-Y Gastric Bypass",
    prep:["Pre-op VLCD/GLP-1; liver shrinkage","H. pylori eradication if positive","Supine; split legs; 5 ports; 30° scope","Anti-thrombosis: LMWH 6 h post-op; TED stockings; early mobilization"],
    steps:[
...
{
  id:"gist", dept:"uppergi", name:"Gastrointestinal Stromal Tumor", latin:"Tumor stromalis gastrointestinalis", organ:"Stomach/Small bowel",
  ...
  overview:{
    definition:"Soft-tissue sarcoma arising from KIT-expressing interstitial cells of Cajal (pacemaker cells of the gut); the most common mesenchymal tumor of the GI tract.",
    epidemiology:"Incidence 1–2/100 000/year. Stomach 60%; small bowel 30%; rectum/colon 5%; esophagus 5%. Median age 60 years; equal sex distribution.",
    ...
    classification:[
      ...
      {label:"Modified NIH — High risk",note:">5 cm, >5 mitoses; or any size with >10 mitoses; tumor rupture — adjuvant imatinib 3 years"},
  ...
  diagnosis:{
    history:["Incidental finding on CT/US (40% asymptomatic)","GI bleeding (melena, hematemesis — intraluminal ulceration)","Abdominal mass, discomfort","Obstruction (small bowel GIST)","Weight loss (large tumor)"],
    examination:["Abdominal mass (palpable if large)","Anemia (chronic blood loss)"],
    investigations:[
      {name:"CT chest/abdomen/pelvis (oral + IV contrast)",role:"Characterize lesion (exophytic, submucosal, heterogeneous with necrosis); staging (liver, peritoneal metastases); blush with contrast"},
      {name:"MRI abdomen",role:"Rectal GIST: assess sphincter/mesorectal involvement; soft-tissue detail"},
      {name:"EUS + FNA",role:"Submucosal lesion characterization; tissue for CD117/CD34/DOG1 IHC + molecular analysis (KIT/PDGFRA mutation)"},
      {name:"EGD/flexible sigmoidoscopy",role:"Identify lesion; biopsy if ulcerated; submucosal location — regular biopsy often non-diagnostic"},
  ...
  technique:{
    ...
    steps:[
      {n:1,t:"Localize tumor",d:"Simultaneous EGD; transilluminate to locate; palpate laparoscopically or use laparoscopic US"},
...
},
{
  ...
  severity:"medium", tags:["Barrett","esophagus","adenocarcinoma","RFA","EMR","surveillance","intestinal metaplasia"],
  ...
  keypoints:[
    ...
    "GERD → columnar metaplasia (incomplete IM = goblet cells) → LGD → HGD → T1a intramucosal carcinoma → T1b submucosal invasive",
  ...
  differentials:["Columnar-lined esophagus without intestinal metaplasia (not Barrett's — no cancer risk)","Sliding hiatus hernia (normal GEJ position when reduced)","Reflux esophagitis (erythematous mucosa — must biopsy)","Esophageal adenocarcinoma (mass lesion within Barrett's)","Gastric cardiac mucosa"],
  ...
  diagnosis:{
    history:["Chronic heartburn, regurgitation (>5 years)","Male, overweight, >50 years","Alarm symptoms: dysphagia, weight loss, anemia (concerning for OAC)"],
    examination:["Usually normal","Obese; signs of GERD"],
    investigations:[
      {name:"EGD + 4-quadrant biopsies",role:"Prague classification (circumferential C and maximal M extent); 4-quadrant every 2 cm + targeted biopsies of any visible lesions (Seattle protocol)"},
  ...
  criteria:{
    ...
    items:[
      {k:"No dysplasia, short segment (<3 cm)",v:"EGD every 3–5 years (2022 BSG: consider stopping in low-risk patients >75)"},
      {k:"No dysplasia, long segment (≥3 cm)",v:"EGD every 2–3 years"},
      ...
      {k:"T1b submucosal cancer",v:"Surgery (esophagectomy) or definitive CRT; EMR + RFA alone insufficient"}
    ]
  },
  scoring:[],
  management:{
    ...
    surgical:[
      ...
      {name:"Radiofrequency ablation (RFA — Halo)",when:"Flat LGD; flat HGD (after EMR of any visible lesion); residual IM post-EMR",notes:"Halo360 balloon (circumferential) → Halo90 focal; multiple sessions (2–4); 80% CE-IM; follow up EGD 3-monthly × 1 year, then annually"},
      {name:"Endoscopic submucosal dissection (ESD)",when:"Large flat visible lesion >2 cm; difficult EMR; T1b confirmed pathologically after EMR",notes:"En bloc resection; allows complete staging; technically demanding; expert centers"},
      {name:"Esophagectomy",when:"T1b (SM2/3) on EMR pathology; HGD/T1a failing endoscopic therapy; T1b + LVI",notes:"Ivor Lewis preferred; only if endotherapy fails or stage requires; high morbidity"}
    ]
  },
  technique:{
    title:"Radiofrequency Ablation (HALO360) for Barrett's",
    prep:["All visible lesions treated with EMR first (histology to confirm T1a, no LVI)","Sizing balloon catheter (measures esophageal diameter)","Conscious sedation or GA","Fluoroscopy optional"],
    steps:[
    ...
    pearls:["CE-IM rate 80% after 2–4 sessions; persistent islands require focal ablation (Halo90)","Post-RFA surveillance indefinitely — IM can recur in 20% at 5 years","EMR before RFA for any visible lesion — RFA of unrecognized cancer is inadequate treatment","T1b disease on EMR histology: refer for surgery — RFA alone inadequate"]
  },
  guidelines:[{src:"BSG Barrett's Esophagus Guidelines 2013 (updated 2022)"},{src:"ESGE Barrett's Guideline 2017 (updated 2022)"},{src:"AspECT Trial: Jankowski et al., Lancet 2018"}],
...
{
  id:"zenker", dept:"uppergi", name:"Zenker's Diverticulum", latin:"Diverticulum Zenker", organ:"Esophagus",
  ...
  keypoints:[
    ...
    "Endoscopic stapler myotomy (Dohlman): first-line; divides cricopharyngeal bar between sac and esophagus; <1 h; 90% success",
    "External approach (Zenker diverticulectomy + cricopharyngeal myotomy): larger sacs; failed endoscopic; better durability"
  ],
  differentials:["Esophageal stricture (dysphagia to solids progressively)","Achalasia (dysphagia liquids + solids)","Esophageal cancer","Epiphrenic diverticulum (lower esophagus)","Globus pharyngeus (functional)"],
  mnemonics:[{name:"Killian's Dehiscence",text:"Posterior midline weak spot between thyropharyngeus (oblique fibers) and cricopharyngeus (horizontal fibers). Increased pharyngeal pressure → pulsion diverticulum through this dehiscence"}],
  overview:{
    ...
    epidemiology:"Prevalence 0.01–0.1%; predominantly men >60 years; accounts for most symptomatic esophageal diverticula.",
    pathophysiology:"Cricopharyngeal dysmotility (incomplete relaxation or hypertonia) → increased pharyngeal pressure → mucosa herniates through Killian's dehiscence → sac develops over years. Sac fills with food → regurgitation → aspiration pneumonia if unrecognized.",
    classification:[
  ...
  diagnosis:{
    ...
    investigations:[
      {name:"Barium swallow",role:"Gold standard: posterior midline sac; sac size; esophageal axis; cricopharyngeal bar; functional assessment"},
      {name:"EGD",role:"Done with care; sac visible; assess cricopharyngeal bar; exclude concurrent malignancy; risk of scope entering sac and perforating"},
      {name:"HRM (esophageal manometry)",role:"Cricopharyngeal dysmotility if symptoms atypical; before surgical planning"}
    ]
  },
  criteria:{
  ...
  management:{
    ...
    surgical:[
      {name:"Endoscopic stapler myotomy (Dohlman/FESS)",when:"Sac ≥2 cm; preferred first-line; excellent results",notes:"Rigid diverticuloscope; divide common wall between sac and esophagus using endoscopic stapler; no sac excision; day case; quick recovery; 90% relief"},
      {name:"Flexible endoscopic myotomy (SEM/DEM)",when:"Good visualization; growing evidence; avoids rigid scope positioning",notes:"Flexible scope with needle knife; divide septum; coagulation; clips on mucosa; comparable to rigid"},
  ...
  technique:{
    ...
    steps:[
      {n:1,t:"Diverticuloscope placement",d:"Two-lipped diverticuloscope; anterior lip in esophagus, posterior lip in sac; expose common wall (cricopharyngeal bar)"},
      ...
      {n:4,t:"Inspect",d:"Confirm adequate myotomy; no perforation; hemostasis; small bleeder → bipolar"},
...
},
{
  ...
  overview:{
    ...
    pathophysiology:"Omphalomesenteric duct normally obliterates by week 7 → failure → Meckel's diverticulum. Heterotopic gastric mucosa (50% of symptomatic): produces HCl → peptic ulceration of adjacent ileum → painless hematochezia. Fibrous band (obliterated remnant) → internal hernia/volvulus.",
    classification:[
  ...
  diagnosis:{
    ...
    investigations:[
      ...
      {name:"Angiography / CT angiography",role:"Active bleeding (>0.5 mL/min): localizes site; guides embolization (temporizing) or surgical exploration"},
  ...
  scoring:[],
  management:{
    conservative:["Observation for asymptomatic wide-neck Meckel's in adults","Blood transfusion for hemorrhage","Nutritional support"],
    medical:["No pharmacological treatment"],
    surgical:[
  ...
  mistakes:["Diverticulectomy leaving ectopic tissue at base — recurrent bleeding","Negative Meckel's scan = no further workup in child with rectal bleeding — capsule endoscopy or laparoscopy needed","Not running the bowel at appendectomy — Meckel's can mimic appendicitis; always inspect to 2 feet from IC valve","Wide-base diverticulectomy causing ileal stenosis — resect with anastomosis instead"]
},
{
  id:"caustic-oesoph", dept:"uppergi", name:"Caustic Esophageal Injury", latin:"Laesio oesophagi caustica", organ:"Esophagus",
  severity:"high", tags:["caustic","alkali","acid","stricture","esophagus","endoscopy","dilation","esophagectomy"],
  hero:"Corrosive injury to esophagus and stomach from ingestion of alkali or acid; causes can range from mild mucosal erythema to full-thickness necrosis requiring emergency resection.",
  keypoints:[
    "Alkali (lye, drain cleaners): liquefactive necrosis — deeper penetration; stomach less affected (neutral pH)",
    "Acid (battery acid): coagulative necrosis — stomach severely affected; esophagus relatively protected by mucus",
    "Zargar endoscopic classification (grades 0–3b) guides management and predicts stricture formation",
    "Emergency EGD within 12–24 h: only gentle endoscopy to grade injury; do NOT pass beyond injury in Grade 3b",
    "Late stricture (4–6 weeks post-injury): balloon dilation + steroid injection; esophagectomy with colon/gastric conduit for refractory stricture"
  ],
  differentials:["Esophageal foreign body","Spontaneous esophageal perforation","Pill-induced esophagitis","Esophageal cancer (late stricture — always biopsy)","Radiation esophagitis"],
  ...
  overview:{
    definition:"Chemical burn injury to the esophagus (and stomach) caused by ingestion of corrosive substances, with outcome ranging from mucosal irritation to transmural necrosis.",
    ...
    pathophysiology:"Alkali: saponification of fats + protein denaturation → liquefactive necrosis → deep penetration. Acid: coagulative necrosis → eschar → relative barrier to penetration. Esophagus: worst with alkali. Stomach: worst with acid (pyloric antrum). Neutrophil infiltration → collagen deposition → stricture (4–6 weeks).",
    classification:[
      {label:"Grade 0",note:"Normal mucosa"},
      {label:"Grade 1",note:"Erythema, edema — no stricture risk; observe and discharge"},
      {label:"Grade 2a",note:"Superficial erosions, fragile mucosa — low stricture risk"},
      {label:"Grade 2b",note:"Deep ulcers, exudate, hemorrhage — 70–80% develop stricture"},
      {label:"Grade 3a",note:"Small areas of necrosis (brownish/grayish) — 90% develop stricture; partial resection may be needed"},
  ...
  diagnosis:{
    ...
    examination:["Oral burns, whitish coating, necrosis","Respiratory distress (laryngeal edema)","Peritonism (gastric perforation)","Shock (transmural necrosis)"],
    investigations:[
      {name:"Chest/abdominal X-ray",role:"Free air (perforation); mediastinal widening (esophageal injury); subcutaneous emphysema"},
      {name:"CT chest/abdomen (acute)",role:"Transmural injury (Grade 3b): full-thickness edema/air/necrosis; guides surgical planning; free air"},
      {name:"Flexible EGD (within 12–24 h)",role:"Gold standard for grading; Zargar classification; gentle — stop at injury; do NOT progress through 3b injury (perforation risk)"},
      {name:"Barium/Gastrografin swallow",role:"Late presentation: stricture characterization; do not use acutely if perforation suspected"}
    ]
  },
  criteria:{
    ...
    items:[
      ...
      {k:"Grade 3a",v:"Intensive care; IV antibiotics; PPI; early repeat EGD; serial CT; surgical consultation"},
      {k:"Grade 3b",v:"Emergency laparotomy/thoracotomy; esophagogastrectomy; cervical esophagostomy; jejunostomy; delayed reconstruction (colon/gastric conduit 6–12 months)"}
    ]
  },
  scoring:[],
  management:{
    ...
    medical:["Steroids (prednisolone) for Grade 2b: reduces stricture formation (studies mixed; most centers use for Grade 2b)","NOT recommended for Grade 3a/3b (increases infection risk)","Late stricture: regular balloon dilation (4–6 weeks post-injury); intralesional steroid injection at dilation"],
    surgical:[
      {name:"Emergency esophagogastrectomy",when:"Grade 3b; transmural necrosis; perforation; hemodynamic instability",notes:"Laparotomy + right thoracotomy; remove all necrotic tissue; cervical esophagostomy (spit fistula); feeding jejunostomy; reconstruction with colon interposition 6–12 months later"},
      {name:"Esophageal reconstruction",when:"Refractory stricture not amenable to dilation; multiple failed dilations; Grade 2b/3a long stricture",notes:"Colon interposition (preferred for caustic — long segment); substernal or posterior mediastinal route; or gastric pull-up if stomach unaffected"},
      {name:"Esophageal balloon dilation",when:"Grade 2b/3a stricture at 4–6 weeks",notes:"Fluoroscopic guidance; hydrostatic balloon; start 12 mm, step up to 18 mm over serial sessions; 70% long-term success; repeat every 3–6 weeks as needed; steroid injection reduces re-stenosis"}
    ]
  },
  technique:{
    title:"Acute EGD for Caustic Injury Assessment",
    prep:["Resuscitation; airway assessment (laryngeal involvement)","Laryngoscopy if stridor present","IV PPI + broad-spectrum antibiotics before EGD","Gentle sedation; have surgical team on standby for Grade 3b"],
    steps:[
      {n:1,t:"Oral assessment",d:"Grade oral injury; check for laryngeal involvement"},
      {n:2,t:"Gentle esophageal passage",d:"Pass scope slowly; grade injury; document extent"},
    ...
    pearls:["Never force EGD past grade 3b injury — perforation risk","CT before EGD if hemodynamic instability or suspected perforation","Late esophageal cancer: caustic stricture increases squamous cell carcinoma risk 40-fold; annual surveillance after 15–20 years","Colon interposition: preferred for long-segment caustic stricture — stomach may also be damaged"]
  },
...
},
{
  ...
  keypoints:[
    ...
    "Carcinoid syndrome: flushing, diarrhea, bronchospasm, tricuspid valve disease — only when liver metastases bypass hepatic serotonin metabolism",
    "Mesenteric fibrosis: desmoplastic reaction around mesenteric nodes → vascular encasement → short bowel from ischemia",
  ...
  differentials:["Crohn's disease (terminal ileitis)","Lymphoma (ileal)","Adenocarcinoma of small bowel (rare)","Meckel's diverticulum","Mesenteric ischemia"],
  mnemonics:[{name:"Carcinoid Syndrome Criteria",text:"Flushing + Diarrhea + Wheezing + Right-sided heart disease = Carcinoid syndrome. ONLY with liver metastases (hepatic metabolism bypassed). 5-HIAA >30 mg/24h confirms serotonin excess"}],
  overview:{
    definition:"Well-differentiated neuroendocrine tumor arising from enterochromaffin (Kulchitsky) cells of the small bowel, predominantly the terminal ileum.",
    epidemiology:"Incidence 2–3/100 000/year; rising with cross-sectional imaging. 50% have metastases at diagnosis. 5-year survival: localized 93%, nodal 89%, distant 60%.",
    pathophysiology:"Enterochromaffin cells secrete serotonin (5-HT) → vasoactive → diarrhea, flushing. Hepatic metabolism normally neutralises serotonin — liver metastases bypass this → carcinoid syndrome. Desmoplastic reaction around mesenteric deposits → fibrosis → vascular/lymphatic encasement → mesenteric ischemia.",
    classification:[
  ...
  diagnosis:{
    ...
    investigations:[
      ...
      {name:"Plasma chromogranin A (CgA)",role:"Elevated in all NETs; correlates with tumor burden; monitors treatment response"},
      ...
      {name:"CT abdomen/pelvis (triple phase)",role:"Primary tumor often small and missed; mesenteric mass (mesenteric fibrosis = tethered mesentery); liver metastases (arterially enhancing)"},
  ...
  criteria:{
    ...
    items:[
      {k:"Localized G1/G2",v:"Curative surgical resection with regional lymphadenectomy"},
      ...
      {k:"Carcinoid syndrome control",v:"SSAs (octreotide LAR 20–30 mg IM monthly); telotristat (tryptophan hydroxylase inhibitor) for refractory diarrhea"},
      ...
      {k:"Carcinoid crisis",v:"IV octreotide 100–500 μg bolus; triggered by anesthesia/surgery; prevent by pre-op subcutaneous octreotide depot"}
    ]
  },
  scoring:[],
  management:{
    conservative:["Dietary triggers avoidance (alcohol, fermented foods, catecholamine-containing foods)","Pre-op octreotide depot (lanreotide or octreotide LAR) to prevent carcinoid crisis during anesthesia"],
    medical:["Somatostatin analogues: octreotide LAR 20–30 mg IM monthly or lanreotide 60–120 mg deep SC; controls symptoms 70–85%; PROMID trial: disease stabilization in midgut NET","Telotristat ethyl: inhibits serotonin synthesis; approved for refractory carcinoid diarrhea","Everolimus/sunitinib: progressive midgut NET (RADIANT-2 trial)","PRRT (Lu-177 DOTATATE): NETTER-1 trial — 79% PFS improvement for progressive G1/G2 midgut NET"],
    surgical:[
      {name:"Ileal resection + mesenteric lymphadenectomy",when:"Resectable localized or even metastatic primary tumor (mesenteric fibrosis prevention)",notes:"Wide ileal resection; lymph node dissection (even if involved); important to prevent mesenteric fibrosis and future bowel ischemia; multifocal primaries (30%)"},
      {name:"Liver debulking / ablation",when:"Hepatic metastases (>70% debulking threshold improves symptoms and may improve survival)",notes:"Combine with primary resection; RFA/MWA for small lesions; hepatic arterial embolization/TARE for multiple bilateral lesions"},
      {name:"Emergency right hemicolectomy",when:"Acute bowel obstruction/ischemia from mesenteric fibrosis",notes:"Urgent resection; mesenteric fibrosis may make complete resection difficult; assess bowel viability carefully"}
    ]
  },
  technique:{
    ...
    steps:[
      {n:1,t:"Explore entire small bowel",d:"30% are multifocal — run entire ileum; 60 cm from IC valve; identify all primary tumors"},
    ...
    pearls:["Carcinoid crisis: sudden severe flushing, hypotension, bronchospasm during anesthesia — IV octreotide 500 μg immediately","Multifocal primaries: 30% — run entire ileum at operation","Mesenteric lymph node dissection: even palliative dissection prevents mesenteric fibrosis and ischemia","PRRT: Lu-177 DOTATATE — 79% PFS improvement in NETTER-1 trial; requires DOTATATE PET positive scan"]
  },
...
},
{
  ...
  keypoints:[
    ...
    "Adaptation: mucosal hyperplasia, villous elongation — maximized by enteral nutrition (luminal stimulation)",
  ...
  mnemonics:[{name:"TPN Dependence Thresholds",text:"End jejunostomy: <100 cm remaining small bowel → likely TPN dependent. Intact ileocecal valve + colon: <50 cm tolerates enteral. Colon adaptation is key: absorbs fluid, ferments carbs to SCFA"}],
  overview:{
    ...
    epidemiology:"Prevalence 3–4/million in UK; Crohn's disease (most common cause — 35%); mesenteric ischemia; volvulus; radiation; atresia. Home TPN patients: 3000–4000 in UK.",
    pathophysiology:"Loss of absorptive surface → malabsorption → diarrhea, dehydration, malnutrition. Intact colon = crucial adaptation (absorbs fluid, bacterial fermentation of carbohydrate → SCFA → colonocyte nutrition). Massive gastric acid hypersecretion (first 6 months) — treat with PPI. Bacterial overgrowth → D-lactic acidosis in jejunocolonic anastomosis.",
    classification:[
      ...
      {label:"Type 3 (jejunoileal anastomosis)",note:"Intact colon and ileocecal valve; best adaptation potential; may achieve enteral autonomy"}
    ]
  },
  diagnosis:{
    history:["History of bowel resection (Crohn's, mesenteric ischemia, volvulus, trauma, radiation)","High stoma output (>2 L/day)","Malnutrition, weight loss","Electrolyte disturbances (sodium, magnesium depletion)","TPN dependence","Recurrent sepsis (CVAD infections)"],
    examination:["Malnutrition, cachexia","Peripheral edema (hypoalbuminemia)","Stoma (high-output)","Micronutrient deficiencies: B12, fat-soluble vitamins, zinc"],
    investigations:[
  ...
  technique:{
    ...
    prep:["CT/MRI documents dilated bowel segment","Length must be adequate (>150 cm remaining + dilation >4 cm)","Nutritional optimization before surgery"],
    steps:[
...
},
{
  ...
  keypoints:[
    ...
    "Chronic radiation enteritis (3 months to years post-RT): progressive obliterative endarteritis → mucosal ischemia → stricture, fistula, bleeding",
  ...
  differentials:["Crohn's disease (chronic inflammation, similar stricture/fistula pattern)","Recurrent malignancy (must biopsy stricture/fistula)","IBD (UC/Crohn's — distinguish by history)","Ischemic enteritis/colitis","Infective enterocolitis"],
  ...
  overview:{
    definition:"Inflammatory and fibrovascular injury to the intestine caused by ionizing radiation, occurring acutely during treatment or chronically months to years after completion.",
    ...
    pathophysiology:"Acute: direct mucosal crypt cell death → mucosal inflammation → diarrhea (self-limiting 2–4 weeks). Chronic: obliterative endarteritis (endothelial proliferation + subintimal fibrosis) → progressive mucosal ischemia → atrophy, fibrosis → stricture, fistula (enterovaginal, enterorectal, enterovesical), bleeding, abscess.",
    classification:[
  ...
  diagnosis:{
    history:["History of pelvic/abdominal RT (prostate, cervical, rectal, bladder cancer)","Diarrhea, malabsorption","Rectal bleeding, tenesmus, rectal stricture (radiation proctitis)","Features of obstruction (chronic stricture)","Fistula: rectovaginal (stool PR/vagina), vesicointestinal (pneumaturia, fecuria)","Malnutrition, weight loss"],
    ...
    investigations:[
      ...
      {name:"MRI pelvis",role:"Fistula characterization (rectovaginal, enterovaginal, vesicointestinal); soft tissue detail"},
  ...
  scoring:[],
  management:{
    conservative:["Elemental or semi-elemental diet; TPN if severely malnourished","Anti-diarrheal agents: loperamide, codeine phosphate","Sucralfate enemas (radiation proctitis): reduces bleeding and inflammation","Mesalazine enemas/suppositories: adjunct for proctitis"],
    medical:["Hyperbaric oxygen therapy (HBO): 20–40 sessions at 2.5 atm; promotes angiogenesis in ischemic tissue; reduces bleeding and fistula formation","Pentoxifylline + vitamin E: improves microvascular perfusion; evidence in radiation fibrosis"],
    surgical:[
      {name:"Defunctioning loop ileostomy",when:"Rectovaginal/enterocutaneous fistula; protecting healing anastomosis; severe radiation proctitis not responding to medical treatment; first-line surgical step",notes:"Avoids high-risk resection acutely; allows nutritional optimization; fistula may heal with diversion alone (20%)"},
  ...
  technique:{
    ...
    prep:["Nutritional optimization (TPN if necessary)","Stoma therapist marking for RIF position","GA; supine; laparoscopic or open"],
    steps:[
