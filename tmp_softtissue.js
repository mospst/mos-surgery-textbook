...

{
  id: "dfsp",
  dept: "soft-tissue",
  name: "Dermatofibrosarcoma Protuberans & Abdominal-Wall Sarcoma",
  latin: "Dermatofibrosarcoma protuberans",
  organ: "Skin / Abdominal wall",
  severity: "moderate",
  tags: ["soft-tissue","sarcoma","DFSP","skin","abdominal-wall"],
  hero: "DFSP is a low-grade, locally aggressive cutaneous sarcoma with fingerlike subclinical spread and a hallmark COL1A1-PDGFB translocation that makes it imatinib-sensitive. Wide excision (or Mohs) with clear margins is the cornerstone; the same wide-margin principle applies to abdominal-wall soft-tissue sarcomas.",
  keypoints: [
    "DFSP: a low-grade dermal sarcoma that is locally aggressive with a high local-recurrence tendency but rarely metastasizes",
    "Characteristic t(17;22) COL1A1-PDGFB translocation drives PDGFB overexpression — the basis for imatinib sensitivity",
    "CD34-positive, storiform spindle-cell pattern on histology; fingerlike subclinical extensions explain recurrence after narrow excision",
    "Wide local excision with 2–3 cm margins down to and including deep fascia, or Mohs micrographic surgery, gives the best local control",
    "Imatinib (a PDGFR inhibitor) for unresectable, recurrent, or metastatic DFSP, and as a neoadjuvant to shrink large tumors",
    "Fibrosarcomatous transformation (FS-DFSP) raises metastatic potential — treat as an intermediate/high-grade sarcoma",
    "Abdominal-wall soft-tissue sarcomas: wide excision with negative margins (usually 1–2 cm) including full-thickness fascia/muscle, then mesh reconstruction"
  ],
  differentials: [
    "Dermatofibroma / benign fibrous histiocytoma (CD34-negative, factor XIIIa-positive)",
    "Desmoid tumor (aggressive fibromatosis)",
    "Keloid or hypertrophic scar",
    "Undifferentiated pleomorphic sarcoma",
    "Morpheaform basal cell carcinoma (if superficial)",
    "Nodular fasciitis"
  ],
  mnemonics: [
    { name: "DFSP molecular", text: "COL1A1-PDGFB t(17;22) → PDGFB drive → imatinib works; CD34+ storiform pattern" },
    { name: "Margins", text: "DFSP 2–3 cm (or Mohs) to deep fascia; other abdominal-wall STS 1–2 cm full-thickness" }
  ],
  overview: {
    definition: "Dermatofibrosarcoma protuberans is a low-grade fibroblastic cutaneous sarcoma. Abdominal-wall sarcomas are soft-tissue sarcomas arising in the musculoaponeurotic layers of the abdominal wall; both are managed by wide margin-negative excision.",
    epidemiology: "DFSP is rare (~1 per million per year), typically affecting the trunk and proximal limbs in young to middle-aged adults. Abdominal-wall sarcomas are likewise uncommon and include desmoid (covered separately), DFSP, and pleomorphic/other soft-tissue sarcomas.",
    pathophysiology: "In DFSP, a t(17;22) translocation fuses COL1A1 with PDGFB, leading to constitutive PDGF receptor-beta signalling and fibroblast proliferation; growth is infiltrative with tentacle-like projections beyond the clinical margin, driving recurrence. Fibrosarcomatous change introduces higher-grade behavior and true metastatic risk (usually to lung). Abdominal-wall sarcomas behave like soft-tissue sarcomas elsewhere — grade drives metastatic risk, with hematogenous spread to lung.",
    classification: [
      "Classic DFSP — low grade, locally aggressive, rarely metastatic",
      "Fibrosarcomatous DFSP (FS-DFSP) — intermediate/high grade, higher recurrence and metastatic potential",
      "Pigmented DFSP (Bednar tumor) — melanin-containing variant",
      "Abdominal-wall soft-tissue sarcoma — graded (e.g. FNCLCC) like other STS; desmoid is a distinct entity"
    ]
  },
  diagnosis: {
    history: [
      "Slowly growing, firm, often violaceous skin plaque or nodule, commonly on the trunk",
      "Long history with recent more rapid growth or nodularity (possible fibrosarcomatous change)",
      "Prior 'recurrent scar' excised more than once (classic for under-treated DFSP)",
      "For abdominal-wall sarcoma: an enlarging deep abdominal-wall mass"
    ],
    examination: [
      "Indurated cutaneous plaque with protuberant nodules; fixed to skin, mobile over deep tissue early on",
      "Assess size, fixation to fascia/muscle, and the relationship to previous scars",
      "Regional nodes usually normal (nodal spread is rare in DFSP and most sarcomas)",
      "For abdominal-wall masses, assess full-thickness involvement and reducibility (to exclude hernia)"
    ],
    investigations: [
      { name: "Core needle or incisional biopsy", role: "Establishes diagnosis; for an extremity/trunk mass orient any incisional biopsy longitudinally so the tract can be excised en bloc" },
      { name: "Immunohistochemistry (CD34)", role: "DFSP is diffusely CD34-positive and factor XIIIa-negative, distinguishing it from dermatofibroma" },
      { name: "Molecular testing (COL1A1-PDGFB)", role: "Confirms DFSP and predicts imatinib responsiveness in advanced disease" },
      { name: "MRI of the lesion", role: "Defines deep extent and fascial/muscle involvement for surgical planning, especially larger or recurrent tumors" },
      { name: "CT chest", role: "Staging for fibrosarcomatous DFSP or high-grade abdominal-wall sarcoma (lung is the dominant metastatic site)" }
    ]
  },
  criteria: {
    title: "Excision Margins by Tumor Type",
    items: [
      { k: "DFSP (classic)", v: "2–3 cm peripheral margin to and including deep fascia, or Mohs micrographic surgery" },
      { k: "Fibrosarcomatous DFSP", v: "Wide excision as for intermediate/high-grade sarcoma; consider adjuvant RT" },
      { k: "Abdominal-wall soft-tissue sarcoma", v: "1–2 cm negative margin, full-thickness including fascia/muscle" },
      { k: "Positive/close margin", v: "Re-excise to clear; adjuvant radiotherapy for high-grade or unresectable close margins" }
    ]
  },
  scoring: [],
  management: {
    conservative: [
      "No role for observation in DFSP — it progresses and recurs; surgery is required",
      "Multidisciplinary sarcoma MDT planning for larger or recurrent tumors"
    ],
    medical: [
      "Imatinib (PDGFR inhibitor) for unresectable, recurrent, or metastatic DFSP, and as neoadjuvant therapy to downsize large tumors before surgery",
      "Adjuvant radiotherapy for close/positive margins not amenable to re-excision, or high-grade fibrosarcomatous disease",
      "Systemic chemotherapy considered for metastatic high-grade abdominal-wall sarcoma per sarcoma protocols"
    ],
    surgical: [
      { name: "Wide local excision (DFSP)", when: "Primary treatment for DFSP", notes: "2–3 cm peripheral margins down to and including the deep fascia; orient and mark the specimen; reconstruct with flap or graft as needed once margins are confirmed clear" },
      { name: "Mohs micrographic surgery", when: "DFSP in cosmetically/functionally sensitive sites, or to maximize margin control with tissue sparing", notes: "Complete circumferential peripheral and deep margin assessment tracks the fingerlike extensions; very low recurrence" },
      { name: "Full-thickness abdominal-wall resection + reconstruction", when: "Abdominal-wall soft-tissue sarcoma or deep/recurrent DFSP involving muscle", notes: "En-bloc excision including involved fascia/muscle with negative margins; reconstruct the defect with mesh (± component separation) and soft-tissue/flap cover" }
    ]
  },
  technique: {
    title: "Wide Local Excision of DFSP with Delayed Reconstruction",
    prep: [
      "Biopsy-confirmed diagnosis with CD34/molecular support",
      "MRI to define deep extent; mark 2–3 cm margins beyond the clinical/prior-scar edge",
      "Plan reconstruction; consider staged closure pending margin confirmation"
    ],
    steps: [
      { n: 1, t: "Mark margins", d: "Measure 2–3 cm around the tumor or previous scar; plan excision to and including the deep fascia" },
      { n: 2, t: "Excise en bloc", d: "Remove the tumor with the underlying fascia (and muscle if involved) as a single oriented specimen" },
      { n: 3, t: "Orient for pathology", d: "Ink and tag the specimen; request complete margin assessment given the infiltrative growth" },
      { n: 4, t: "Delay closure if needed", d: "Temporary dressing/negative-pressure while awaiting final margins; re-excise any positive margin before definitive reconstruction" },
      { n: 5, t: "Reconstruct", d: "Primary closure, flap, or graft; mesh reconstruction for full-thickness abdominal-wall defects" }
    ],
    pearls: [
      "DFSP's fingerlike extensions cause recurrence after narrow excision — wide margins or Mohs are essential",
      "Confirm clear margins before committing to a complex flap; delayed reconstruction avoids burying positive margins",
      "Neoadjuvant imatinib can shrink a large or difficult DFSP to make margin-negative surgery achievable"
    ]
  },
  guidelines: [
    { src: "NCCN Guidelines — Dermatofibrosarcoma Protuberans" },
    { src: "ESMO Clinical Practice Guidelines — Soft Tissue and Visceral Sarcomas" }
  ],
  pearls: [
    "CD34 positivity and the COL1A1-PDGFB translocation define DFSP and separate it from a benign dermatofibroma",
    "The translocation makes advanced DFSP uniquely responsive to imatinib",
    "Treat fibrosarcomatous DFSP as a genuine sarcoma — it can metastasize to the lung"
  ],
  mistakes: [
    "Narrow 'shave' excision of an apparent scar/keloid that is actually DFSP — near-inevitable recurrence",
    "Not sending tissue for CD34/molecular testing and mislabelling it a dermatofibroma",
    "Forgetting chest staging in fibrosarcomatous DFSP or high-grade abdominal-wall sarcoma"
  ]
}
