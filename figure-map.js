...
module.exports = {
  ...
  'anal-fistula': ['parks-anal-fistula', 'goodsall-rule'],
  'perianal-abscess': ['parks-anal-fistula', 'goodsall-rule'],
  'crc': ['colonic-resection-extents', 'haggitt-levels'],
  ...
  'rectal-prolapse': ['rectal-prolapse-repairs'],
  'lynch': ['lynch-mmr-algorithm'],
  'crs-hipec': ['peritoneal-cancer-index'],
